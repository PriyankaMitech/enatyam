        ...
        <div class="col-lg-12 col-md-12 col-12 p-5 mt-5" style="background-color: black;">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-12 textPara-col kathakp">
                        <h2 class="heading text-white">Learn, Play, and Excel with Our Piano Lessons!</h2>
                        <p class="text-white">
                        The piano, with its grand heritage and versatile capabilities, stands as one of the most beloved instruments in the world. From classical compositions to contemporary hits, the piano's rich and expressive tones have the power to convey a wide range of emotions, making it a favorite among musicians and listeners alike.                        </p>
                    ...
                    <div class="col-lg-6 col-md-6 col-12  textPara-col kathakp" >
                        <img src="<?php echo  base_url(); ?>public/images/instrument/Piano.jpeg" class="rightimg" alt="Yoga Class" style="width:100%;">
                    </div>
                </div>
            </div>
        </div>
