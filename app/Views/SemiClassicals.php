        ...
        <div class="col-lg-12 col-md-12 col-12 p-5 mt-5">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-12 textPara-col kathakp">
                        <h2 class="heading text-white p-0">Explore the Fusion of Styles with Our Semi-Classical Vocal Course!</h2>
                        <p class="text-white">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 textPara-col kathakp">
                        <img src="<?=base_url(); ?>public/images/courseoffering/SEMICLASICAL.jpg" class="rightimg" alt="semiclassicals1" style="width:100%;">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="typesOfDance-tab">
            <div class=" ">
                <div class="">
                    ...
                    <img src="<?=base_url(); ?>public/images/boarder1.webp" alt="semiclassicals2" class="img-fluid">
                    </div>
                            ...
                            <div class="ThumbnailImg " style="text-align: center;">
                                <a href="<?= base_url(); ?>online-hindustani-music-classes" target="" class="d-block h-100">
                                    <img class="img-fluid img-thumbnail"
                                        src="<?php echo  base_url(); ?>public/images/courseoffering/5-rbg.webp" alt="semiclassicals3">
                                </a>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            ...
                            <div class="ThumbnailImg " style="text-align: center;">
                                <a href="<?= base_url(); ?>online-carnatic-music-lessons" target="" class="d-block h-100">
                                    <img class="img-fluid img-thumbnail"
                                        src="<?php echo base_url(); ?>public/images/courseoffering/6-rbg.webp" alt="semiclassicals4"
                                       >
                                </a>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            ...
                            <div class="ThumbnailImg " style="text-align: center;">
                                <a href="<?= base_url(); ?>online-semiclassical-music-lessons" target="" class="d-block h-100">
                                    <img class="img-fluid img-thumbnail"
                                        src="<?php echo base_url(); ?>public/images/courseoffering/7-rbg.webp" alt="semiclassicals5"
                                       >
                                </a>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            ...
                            <div class="ThumbnailImg " style="text-align: center;">
                                <a href="<?= base_url(); ?>online-western-singing-classes" target="" class="d-block h-100">
                                    <img class="img-fluid img-thumbnail"
                                        src="<?php echo base_url(); ?>public/images/courseoffering/8-rbg.webp" alt="semiclassicals6"
                                       >
                                </a>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            ...
                            <div class="ThumbnailImg " style="text-align: center;">
                                <a href="<?= base_url(); ?>online-playback-singing-classes" target="" class="d-block h-100">
                                    <img class="img-fluid img-thumbnail"
                                        src="<?php echo base_url(); ?>public/images/Music/musicImg1.svg" alt="semiclassicals7"
                                       >
                                </a>
                            </div>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <img src="<?=base_url(); ?>public/images/courseoffering/5-rbg.webp" class="danceimg wsized" alt="semiclassicals8">
                                </div>
                            ...
                            <div class="row kathakp">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="learnMusicImg">     
                                        <img src="<?=base_url(); ?>public/images/Music/musicImg2.svg" class="danceimg" alt="semiclassicals9">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="month-row">
                                ...
                                <div class="col-lg-12 col-12 text-center testimonialsdiv">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center mbfim">
                                        <img src="<?=base_url(); ?>public/images/Music/musicImg3.svg" class="danceimg danceimg5" alt="semiclassicals10">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="semiclassicals11">
                                                    Live Private class -8
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="semiclassicals12">
                                                    Practice video -6
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp" alt="semiclassicals13">
                ...
                <div class="tab-pane fade" id="pills-CarnaticVocal" role="tabpanel" aria-labelledby="pills-CarnaticVocal-tab">
                    <section class="dancedesc">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-12">
                                    <img src="<?=base_url(); ?>public/images/courseoffering/6-rbg.webp" class="danceimg wsized" alt="semiclassicals14">
                                </div>
                                <div class="col-lg-6 col-md-6 col-12 text-left text-col musicp">
                    ...
                    <section class="learningsec yellowb" id="learncarnatic">
                        <div class="container">
                            <div class="row kathakp">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 ">
                                    <div class="learnMusicImg">     
                                        <img src="<?=base_url(); ?>public/images/Music/musicImg2.svg" class="danceimg" alt="semiclassicals15">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container">
                            ...
                            <div class="month-row">
                                ...
                                <div class="col-lg-12 col-12 text-center testimonialsdiv">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center mbfim">
                                        <img src="<?=base_url(); ?>public/images/Music/musicImg3.svg" class="danceimg danceimg5" alt="semiclassicals16">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="semiclassicals17">
                                                    Live Private class -8
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="semiclassicals18">
                                                    Practice video -6
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp" alt="semiclassicals19">
                                                    Reading content/Quiz - 2
                                                </div>
                                                <div class="module-text">
                ...
                <div class="tab-pane fade show active" id="pills-SemiClassical" role="tabpanel" aria-labelledby="pills-SemiClassical-tab">
                    <section class="dancedesc">
                        <div class="container">
                            ...
                            <img src="<?=base_url(); ?>public/images/boarder1.webp" alt="semiclassicals20" class="img-fluid">
                            </div>
                                <div class="col-lg-6 col-md-6 col-12">
                                <img src="<?=base_url(); ?>public/images/courseoffering/7-rbg.webp" class="danceimg wsized" alt="semiclassicals21" >
                                </div>
                                <div class="col-lg-6 col-md-6 col-12 text-left text-col musicp">
                    ...
                    <section class="learningsec yellowb" id="learnsemi">
                        <div class="container">
                            <div class="row kathakp">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 ">
                                    <div class="learnMusicImg">     
                                        <img src="<?=base_url(); ?>public/images/Music/musicImg2.svg" class="danceimg" alt="semiclassicals22">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container">
                            ...
                            <div class="month-row">
                                ...
                                <div class="col-lg-12 col-12 text-center testimonialsdiv">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center mbfim">
                                        <img src="<?=base_url(); ?>public/images/Music/musicImg3.svg" class="danceimg danceimg5" alt="semiclassicals23">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="semiclassicals24">
                                                    Live Private class -8
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="semiclassicals25">
                                                    Practice video -6
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp" alt="semiclassicals26">
                                                    Reading content/Quiz - 2
                                                </div>
                                                <div class="module-text">
                ...
                <div class="tab-pane fade" id="pills-WesternSinging" role="tabpanel" aria-labelledby="pills-WesternSinging-tab">
                    <section class="dancedesc">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-12">
                                <img src="<?=base_url(); ?>public/images/courseoffering/8-rbg.webp" class="danceimg wsized" alt="semiclassicals27" >
                                </div>
                                <div class="col-lg-6 col-md-6 col-12 text-left text-col musicp">
                    ...
                    <section class="learningsec yellowb" id="learnwestern">
                        <div class="container">
                            <div class="row kathakp">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 ">
                                    <div class="learnMusicImg">     
                                        <img src="<?=base_url(); ?>public/images/Music/musicImg2.svg" class="danceimg" alt="semiclassicals28">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container">
                            ...
                            <div class="month-row">
                                ...
                                <div class="col-lg-12 col-12 text-center testimonialsdiv">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center mbfim">
                                        <img src="<?=base_url(); ?>public/images/Music/musicImg3.svg" class="danceimg danceimg5" alt="semiclassicals29">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="semiclassicals30">
                                                    Live Private class -8
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="semiclassicals31">
                                                    Practice video -6
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp" alt="semiclassicals32">
                                                    Reading content/Quiz - 2
                                                </div>
                                                <div class="module-text">
                ...
                <div class="tab-pane fade" id="pills-PlaybackSinging" role="tabpanel" aria-labelledby="pills-PlaybackSinging-tab">
                    <section class="dancedesc">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-12">
                                    <img src="<?=base_url(); ?>public/images/Music/musicImg1.svg" class="danceimg" alt="semiclassicals33">
                                </div>
                    ...
                    <section class="learningsec yellowb" id="learnplay">
                        <div class="container">
                            <div class="row kathakp">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 ">
                                    <div class="learnMusicImg">    
                                        <img src="<?=base_url(); ?>public/images/Music/musicImg2.svg" class="danceimg" alt="semiclassicals34">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container">
                            ...
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center mbfim">
                                        <img src="<?=base_url(); ?>public/images/Music/musicImg3.svg" class="danceimg danceimg5" alt="semiclassicals35">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="semiclassicals36">
                                                    Live Private class -8
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="semiclassicals37">
                                                    Practice video -6
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp" alt="semiclassicals38">
                                                    Reading content/Quiz - 2
                                                </div>
                                                <div class="module-text">
...
<section class="how_Started-section pb-3 MusicSec ch">
    <div class="container">
        ...
        <div class="col-lg-12 col-md-12 col-12 pb-5 imgs text-center">
                    ...
                    <img src="<?=base_url(); ?>public/images/boarder1.webp" alt="semiclassicals39" class="img-fluid">
                    </div>
        ...
        <div class="row justify-content-center htgs g-3">
            ...
            <div class="col-6 col-md-2 col-lg-4 col-xl-2 text-center mb-4 mb-lg-0">
                <div class="d-flex justify-content-center">
                    <img src="<?php echo base_url(); ?>public/images/ch1.png" alt="semiclassicals40" class="rounded-circle custom-img">
                </div>
            ...
            <div class="col-6 col-md-2 col-lg-4 col-xl-2 text-center mb-4 mb-lg-0">
                <div class="d-flex justify-content-center">
                    <img src="<?php echo base_url(); ?>public/images/ch2.png" alt="semiclassicals41" class="rounded-circle custom-img">
                </div>
                <div class="sc-heading">
            ...
            <div class="col-6 col-md-2 col-lg-4 col-xl-2 text-center mb-4 mb-lg-0">
                <div class="d-flex justify-content-center">
                    <img src="<?php echo base_url(); ?>public/images/ch3.png" alt="semiclassicals42" class="rounded-circle custom-img">
                </div>
                <div class="sc-heading">
            ...
            <div class="col-6 col-md-2 col-lg-4 col-xl-2 text-center mb-4 mb-lg-0">
                <div class="d-flex justify-content-center">
                    <img src="<?php echo base_url(); ?>public/images/ch4.png" alt="semiclassicals43" class="rounded-circle custom-img">
                </div>
                <div class="sc-heading">
            ...
            <div class="col-6 col-md-2 col-lg-4 col-xl-2 text-center mb-4 mb-lg-0">
                <div class="d-flex justify-content-center">
                    <img src="<?php echo base_url(); ?>public/images/ch5.png" alt="semiclassicals44" class="rounded-circle custom-img">
                </div>
                <div class="sc-heading">
                ...
                <div class="owl-carousel owl-theme">
                        <div class="item">
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/1h.webp" class="centered-image" alt="semiclassicals45" />
                                            <div class="hft">
                            ...
                            <div class="item in" >
                                    <div class="happyFaces-div">
                                        <div class="happyFaces-div1 mb-5">
                                            <img src="<?=base_url(); ?>public/images/happyfaces/2h.webp" class="centered-image" alt="semiclassicals46"  />
                                            <div class="hft">
                        ...
                        <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/3h.webp" class="centered-image" alt="semiclassicals47" />
                                        <div class="hft">
                                            <h5>Sneha (Canada )</h5>
                            ...
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 ">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/4h.webp" class="centered-image" alt="semiclassicals48" />
                                        <div class="hft">
                                            <h5>Kavita ( Pune)</h5>
                        ...
                        <div class="item">
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/6h.webp" class="centered-image" alt="semiclassicals49" />
                                        <div class="hft">
                            ...
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 ">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/7h.webp" class="centered-image" alt="semiclassicals50" />
                                        <div class="hft">
                                            <h5>Rajiv ( Lucknow )</h5>
                        ...
                        <div class="item"> 
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/8h.webp" class="centered-image" alt="semiclassicals51" />
                            ...
                            <!-- Your content here -->
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 ">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/10h.webp" class="centered-image" alt="semiclassicals52" />
                                        <div class="hft">
                    ...
                    <div class="item"> 
                        <div class="item in" >
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 mb-5">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/11h.webp" class="centered-image" alt="semiclassicals53" />
                                    <div class="hft">
                                        <h5>Kajal ( Delhi )</h5>
                        ...
                        <!-- Your content here -->
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 ">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/12h.webp" class="centered-image" alt="semiclassicals54" />
                                    <div class="hft">
                    ...
                    <div class="item"> 
                        <div class="item in" >
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 mb-5">
                                <img src="<?=base_url(); ?>public/images/happyfaces/14h.webp" class="centered-image" alt="semiclassicals55" />
                                    <div class="hft">
                                        <h5>Emma ( UK )</h5>
                        ...
                        <!-- Your content here -->
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 ">
                                <img src="<?=base_url(); ?>public/images/happyfaces/15h.webp" class="centered-image" alt="semiclassicals56" />
                                    <div class="hft">
                ...
                <div class="owl-carousel owl-theme">
                        <div class="item">
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/1h.webp" class="centered-image" alt="semiclassicals57" />
                                            <div class="hft">
                                                <h5>Aiden C ( London -Uk)</h5>
                                                <p>Enatyam's yoga courses are a total game-changer for me. The instructors keep it real, making every pose feel achievable. It's like having a personal yoga guide right in my living room.
                                                </p>
                        ...
                        <div class="item">
                            <div class="item in" >
                                    <div class="happyFaces-div">
                                        <div class="happyFaces-div1 mb-5">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/2h.webp" class="centered-image" alt="semiclassicals58"  />
                                            <div class="hft">
                                                <h5>Sweta ( Australia)</h5>
                                                <p>I'm new to yoga, and Enatyam is the perfect starting point. The classes are not intimidating, and the instructors break down each pose in a way that's easy to understand. Feeling more zen already!</p>
                                            </div>
                        ...
                        <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/3h.webp" class="centered-image" alt="semiclassicals59" />
                                        <div class="hft">
                                            <h5>Sneha (Canada )</h5>
                                        <p class="reviewName">Enatyam's yoga classes are like a breath of fresh air. The instructors create a friendly atmosphere, making the sessions enjoyable. It's become a daily ritual that I genuinely look forward to.</p>
                                        </div>
                        ...
                        <div class="item">
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 ">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/4h.webp" class="centered-image" alt="semiclassicals60" />
                                        <div class="hft">
                                            <h5>Kavita ( Pune)</h5>
                                            <p class="reviewName">I've tried a few online yoga platforms, but Enatyam stands out. The variety of classes keeps things interesting, and the instructors feel like friends guiding you through a mindful journey. Highly recommend!</p>
                                        </div>
                        ...
                        <div class="item">
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/6h.webp" class="centered-image" alt="semiclassicals61" />
                                        <div class="hft">
                                            <h5>Ayesha ( Singapore )</h5>
                                            <p class="reviewName">Enatyam's yoga is a perfect fit for a busy mom like me. The quick sessions are manageable, and the instructors make it feel like a mini wellness retreat. Grateful for this accessible and effective platform!</p>
                                        </div>
                        ...
                        <div class="item">
                            <div class="item in" >
                                    <div class="happyFaces-div">
                                        <div class="happyFaces-div1 ">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/7h.webp" class="centered-image" alt="semiclassicals62" />
                                        <div class="hft">
                                            <h5>Rajiv ( Lucknow )</h5>
                                            <p class="reviewName">The variety of yoga classes on Enatyam is impressive. Whether I need a gentle stretch or an energizing flow, there's something for every mood. The instructors make it easy for anyone to enjoy the benefits of yoga.</p>
                                        </div>
                        ...
                        <div class="item"> 
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/8h.webp" class="centered-image" alt="semiclassicals63" />
                                        <div class="hft">
                                        <h5>Vikram ( Delhi )</h5>
                                        <p class="reviewName">Enatyam's yoga classes have made me realize that yoga is for everyone. The inclusive approach of the instructors and the straightforward guidance make it a comfortable and enjoyable practice.</p>
                                        </div>
                        ...
                        <div class="item">
                            ...
                            <!-- Your content here -->
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 ">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/10h.webp" class="centered-image" alt="semiclassicals64" />
                                        <div class="hft">
                                            <h5>Vishal ( Chandigarh )</h5>
                                            <p class="reviewName">I've always struggled to stick with a workout routine, but Enatyam's yoga has been a consistent part of my day. The short sessions fit into my schedule, and the instructors' encouragement keeps me motivated.</p>
                                        </div>
                    ...
                    <div class="item"> 
                        <div class="item in" >
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 mb-5">
                                <img src="<?=base_url(); ?>public/images/happyfaces/11h.webp" class="centered-image" alt="semiclassicals65" />
                                    <div class="hft">
                                        <h5>Kajal ( Delhi )</h5>
                                        <p class="reviewName">I appreciate how Enatyam's yoga classes cater to various levels. Whether you're a beginner or an experienced yogi, there's always room for growth. The instructors make sure everyone feels welcome. </p>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <!-- Your content here -->
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 ">
                                <img src="<?=base_url(); ?>public/images/happyfaces/12h.webp" class="centered-image" alt="semiclassicals66" />
                                    <div class="hft">
                                        <h5>Scarlett family ( Germany )</h5>
                                        <p class="reviewName">Yoga is a daily dose of positivity for me . The instructors radiate good vibes, and the classes have become my source of calm in the midst of a busy schedule. A fantastic platform for holistic well-being!</p>
                                    </div>
                    ...
                    <div class="item"> 
                        <div class="item in" >
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 mb-5">
                                <img src="<?=base_url(); ?>public/images/happyfaces/14h.webp" class="centered-image" alt="semiclassicals67" />
                                    <div class="hft">
                                        <h5>Emma ( UK )</h5>
                                        <p class="reviewName">Yoga is my daily escape from the hustle. The instructors make it easy to disconnect and focus on the present moment. It's a simple yet powerful practice that has become a non-negotiable in my routine.</p>
                                    </div>
                    ...
                    <div class="item">
                        <div class="item in" >
                            <!-- Your content here -->
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 ">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/15h.webp" class="centered-image" alt="semiclassicals68" />
                                    <div class="hft">
                                        <h5>Michael (Mike) ( USA)</h5>
                                        <p class="reviewName">Enatyam's yoga is like a personal wellness retreat at home. The instructors create a serene atmosphere, and the classes feel like a journey into both physical and mental well-being. Truly transformative</p>
                                    </div>
        ...
        <div class="typesOfDance-tab">
            <div class="MusicSec opc">
                <div class="">
                    <div class="row text-lg-start">
                    <div class="col-lg-12 col-md-12 col-12 imgs text-center pb-5">
                    <img src="<?=base_url(); ?>public/images/boarder1.webp" alt="semiclassicals69" class="img-fluid">
                    </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-6">
                            ...
                            <div class="ThumbnailImg " style="text-align: center;">
                                <a href="<?= base_url(); ?>online-stress-reduction-yoga-classes" target="" class="d-block h-100">
                                    ...
                                    <img class="img-fluid img-thumbnail" src="<?php echo base_url(); ?>public/images/courseoffering/opc1.png" alt="semiclassicals70">
                                </a>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-6">
                            ...
                            <div class="ThumbnailImg " style="text-align: center;">
                                <a href="<?= base_url(); ?>online-semiclassical-music-lessons" target="" class="d-block h-100">
                                    <img class="img-fluid img-thumbnail" src="<?php echo base_url(); ?>public/images/courseoffering/opc2.png" alt="semiclassicals71">
                                </a>
                            </div>
                            <div class="text-center mt-2">
                        ...
                        <div class="col-lg-3 col-md-3 col-6">
                            ...
                            <div class="ThumbnailImg " style="text-align: center;">
                               <a href="<?= base_url(); ?>online-bhangra-lessons" target="" class="d-block h-100">
                                    <img class="img-fluid img-thumbnail" src="<?php echo base_url(); ?>public/images/courseoffering/opc3.png" alt="semiclassicals72">
                                </a>
                            </div>
                            <div class="text-center mt-2">
                        ...
                        <div class="col-lg-3 col-md-3 col-6">
                            ...
                            <div class="ThumbnailImg " style="text-align: center;">
                                <a href="<?= base_url(); ?>online-folk-dance-classes" target="" class="d-block h-100">
                                    <img class="img-fluid img-thumbnail" src="<?php echo base_url(); ?>public/images/courseoffering/opc4.png" alt="semiclassicals73">
                                </a>
                            </div>
                            <div class="text-center mt-2">
