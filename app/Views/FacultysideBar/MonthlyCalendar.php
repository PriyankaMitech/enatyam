                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 p-2">
                                        ...
                                        <input type="hidden" name="faculty_register_id" value="
											<?= $id; ?>">
                                        <button type="button" class="btn btn-success" onclick="submitForm()">Save
                                            Data</button>
                                    </div>
                                </div>
                            </form>
            ...
            <div class="row">
                ...
                <div class="col-md-4 ">
                    ...
                    foreach ($filteredSlots as $slot) {
                        ...
                        ?>
                            <button type="button" class="btn btn-sm mr-1 <?= $buttonStyle ?>" style="margin-top: 10px;"
                                <?= $buttonDisabled ?> data-toggle="tooltip"
                                title="This Time Is Booked"><?= $startTime ?> To <?= $endTime ?></button>
                            <?php
                    }
                    ?>
                        </div>
