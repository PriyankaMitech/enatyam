        ...
        <div class="col-lg-12 col-md-12 col-12 p-5" style="background-color: black;">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-12 textPara-col kathakp">
                        <h2 class="heading text-white">Transform Your Body with Our Weight Loss Yoga Course</h2>
                        <p class="text-white">
                        Achieve your fitness goals and embrace a healthier lifestyle with our Weight Loss Yoga course. Designed to help you burn calories, tone muscles, and boost your metabolism, this course is perfect for anyone looking to lose weight in a holistic and sustainable way.                        </p>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 textPara-col kathakp">
                        <img src="<?=base_url(); ?>public/images/Yoga/weightloss.jpeg" class="rightimg" alt="Yoga Class" style="width:100%;">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="typesOfYoga-tab">
            ...
            <div class="tab-content " id="pills-tabContent">
                ...
                <div class="tab-pane fade show active" id="pills-PrenatalYoga" role="tabpanel" aria-labelledby="pills-PrenatalYoga-tab">
                    ...
                    <img src="<?=base_url(); ?>public/images/boarder1.webp" alt="Image Description" class="img-fluid">
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/WeightLossYogaImg.svg" alt="weightloss1"  class="danceimg">
                        </div>
                        ...
                        <div class="container">
                            <div class="row ">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg"   alt="weightloss10" class="danceimg">
                            ...
                            <div class="month-row">
                                ...
                                <div class="col-lg-12 col-12 text-center testimonialsdiv">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg"  alt="weightloss11"  class="danceimgy">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp"  alt="weightloss11">
                                                    Live Private class -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp"  alt="weightloss12">
                                                    Practice video -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp"  alt="weightloss13">
                ...
                <div class="tab-pane fade" id="pills-StressReduction" role="tabpanel" aria-labelledby="pills-StressReduction-tab">
                    <div class="row pddyd">
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/StressReductionImg.svg"  alt="weightloss14"  class="danceimg">
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg"  alt="weightloss15"  class="danceimg">
                        ...
                        <div class="container">
                            ...
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg"  alt="weightloss16"  class="danceimgy">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="weightloss17">
                                                    Live Private class -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="weightloss18">
                                                    Practice video -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp" alt="weightloss19">
                                                    Reading content/Quiz - 2
                                                </div>
                                                <div class="module-text">
                ...
                <div class="tab-pane fade show" id="pills-Flexibility" role="tabpanel" aria-labelledby="pills-Flexibility-tab">
                    <div class="row pddyd">
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/FlexibilityYogaImg.svg" alt="weightloss2" class="danceimg">
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="weightloss21" class="danceimg">
                        ...
                        <div class="container">
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg" alt="weightloss22" class="danceimgy">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp"alt="weightloss23">
                                                    Live Private class -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp"alt="weightloss24">
                                                    Practice video -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp"alt="weightloss25">
                                                    Reading content/Quiz - 2
                                                </div>
                ...
                <div class="tab-pane fade show" id="pills-WeightLossYoga" role="tabpanel" aria-labelledby="pills-WeightLossYoga-tab">
                    <div class="row pddyd">
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/WeightLossYogaImg.svg" alt="weightloss26" class="danceimg">
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                            <h3 class="heading"> Weight Loss Yoga</h3>
                            <p class="">
                    ...
                    <section class="learningsec yellowb" id="learnyoga3">
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <!-- <div class="chgimg" > -->
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="weightloss27" class="danceimg">
                                </div>
                            </div>
                        </div>
                    </section>
                        ...
                        <div class="container">
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg" alt="weightloss28" class="danceimgy">
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-12">
                                        <!-- trying new tab  -->
                                        <ul class="row nav nav-pills mb-3" id="pills-tab" role="tablist">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="weightloss29">
                                                    Live Private class -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="weightloss30">
                                                    Practice video -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp" alt="weightloss31">
                                                    Reading content/Quiz - 2
                                                </div>
                ...
                <div class="tab-pane fade show" id="pills-EverydayYoga" role="tabpanel" aria-labelledby="pills-EverydayYoga-tab">
                    <div class="row pddyd">
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/EverydayYoga.svg" alt="weightloss32" class="danceimg">
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="weightloss33" class="danceimg">
                        ...
                        <div class="container">
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg" alt="weightloss34" class="danceimgy">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp"alt="weightloss35">
                                                    Live Private class -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="weightloss36">
                                                    Practice video -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp" alt="weightloss37">
                                                    Reading content/Quiz - 2
                                                </div>
                ...
                <div class="tab-pane fade show" id="pills-YogaforChronic" role="tabpanel" aria-labelledby="pills-YogaforChronic-tab">
                    <div class="row pddyd">
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/chronicYoga.svg" alt="weightloss38" class="danceimg">
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="weightloss39" class="danceimg">
                        ...
                        <div class="container">
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg" alt="weightloss40" class="danceimgy">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp"alt="weightloss41">
                                                    Live Private class -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="weightloss42">
                                                    Practice video -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp" alt="weightloss43">
                                                    Reading content/Quiz - 2
                                                </div>
                ...
                <div class="tab-pane fade show" id="pills-YogaforKids" role="tabpanel" aria-labelledby="pills-YogaforKids-tab">
                    <div class="row pddyd">
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/YogaforKids.svg" alt="weightloss44" class="danceimg">
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="weightloss45" class="danceimg">
                        ...
                        <div class="container">
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg" alt="weightloss46" class="danceimgy">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp"alt="weightloss47">
                                                    Live Private class -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp"alt="weightloss48">
                                                    Practice video -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp"alt="weightloss49">
                                                    Reading content/Quiz - 2
                                                </div>
                ...
                <div class="tab-pane fade show" id="pills-Meditation" role="tabpanel" aria-labelledby="pills-Meditation-tab">
                    <div class="row pddyd">
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/MeditationImg.svg" alt="weightloss50" class="danceimg">
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="weightloss51" class="danceimg">
                ...
                <div class="tab-pane fade show" id="pills-CustomiseYoga" role="tabpanel" aria-labelledby="pills-CustomiseYoga-tab">
                    <div class="row pddyd">
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/CustomizeYogaImg.svg" alt="weightloss52" class="danceimg">
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="weightloss53" class="danceimg">
                ...
                <div class="tab-pane fade show" id="pills-NutritionCounselling" role="tabpanel" aria-labelledby="pills-NutritionCounselling-tab">
                    <div class="row pddyd">
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/NutritionCounsellingImg.svg" alt="weightloss54" class="danceimg">
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="weightloss55" class="danceimg">
                        ...
                        <div class="container">
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg" alt="weightloss56" class="danceimgy">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="weightloss57">
                                                    Live Private class -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="weightloss58">
                                                    Practice video -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp" alt="weightloss59">
                                                    Reading content/Quiz - 2
                                                </div>
                ...
                <div class="owl-carousel owl-theme">
                        <div class="item">
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/1.png"  alt="weightloss60" class="centered-image" />
                                            <div class="hft">
                            ...
                            <div class="item in" >
                                    <div class="happyFaces-div">
                                        <div class="happyFaces-div1 mb-5">
                                            <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/2.png" alt="weightloss61" class="centered-image"  />
                                            <div class="hft">
                        ...
                        <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/3.png" alt="weightloss62" class="centered-image" />
                                        <div class="hft">
                                            <h5>Sneha (Canada )</h5>
                            ...
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 ">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/4.png" alt="weightloss63" class="centered-image" />
                                        <div class="hft">
                                            <h5>Kavita ( Pune)</h5>
                        ...
                        <div class="item">
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/6.png" alt="weightloss64" class="centered-image" />
                                        <div class="hft">
                            ...
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 ">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/8.png" alt="weightloss65" class="centered-image" />
                                        <div class="hft">
                                            <h5>Rajiv ( Lucknow )</h5>
                        ...
                        <div class="item"> 
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/9.png" alt="weightloss66" class="centered-image" />
                            ...
                            <!-- Your content here -->
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 ">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/5.png" alt="weightloss67" class="centered-image" />
                                        <div class="hft">
                    ...
                    <div class="item"> 
                        <div class="item in" >
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 mb-5">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/13.png" alt="weightloss68" class="centered-image" />
                                    <div class="hft">
                                        <h5>Kajal ( Delhi )</h5>
                        ...
                        <!-- Your content here -->
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 ">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/14.png" alt="weightloss69" class="centered-image" />
                                    <div class="hft">
                    ...
                    <div class="item"> 
                        <div class="item in" >
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 mb-5">
                                <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/7.png" alt="weightloss70" class="centered-image" />
                                    <div class="hft">
                                        <h5>Emma ( UK )</h5>
                        ...
                        <!-- Your content here -->
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 ">
                                <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/11.png"  alt="weightloss71" class="centered-image" />
                                    <div class="hft">
                ...
                <div class="owl-carousel owl-theme">
                        <div class="item">
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/1.png" alt="weightloss72"  class="centered-image" />
                                            <div class="hft">
                                                <h5>Aiden C ( London -Uk)</h5>
                                                <p>Enatyam's yoga courses are a total game-changer for me. The instructors keep it real, making every pose feel achievable. It's like having a personal yoga guide right in my living room.
                                                </p>
                        ...
                        <div class="item">
                            <div class="item in" >
                                    <div class="happyFaces-div">
                                        <div class="happyFaces-div1 mb-5">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/2.png" alt="weightloss73" class="centered-image"  />
                                            <div class="hft">
                                                <h5>Sweta ( Australia)</h5>
                                                <p>I'm new to yoga, and Enatyam is the perfect starting point. The classes are not intimidating, and the instructors break down each pose in a way that's easy to understand. Feeling more zen already!</p>
                                            </div>
                        ...
                        <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                     <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/3.png" alt="weightloss74" class="centered-image" />
                                        <div class="hft">
                                            <h5>Sneha (Canada )</h5>
                                        <p class="reviewName">Enatyam's yoga classes are like a breath of fresh air. The instructors create a friendly atmosphere, making the sessions enjoyable. It's become a daily ritual that I genuinely look forward to.</p>
                                        </div>
                        ...
                        <div class="item">
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 ">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/4.png" alt="weightloss75" class="centered-image" />
                                        <div class="hft">
                                            <h5>Kavita ( Pune)</h5>
                                            <p class="reviewName">I've tried a few online yoga platforms, but Enatyam stands out. The variety of classes keeps things interesting, and the instructors feel like friends guiding you through a mindful journey. Highly recommend!</p>
                                        </div>
                        ...
                        <div class="item">
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/6.png" alt="weightloss76" class="centered-image" />
                                        <div class="hft">
                                            <h5>Ayesha ( Singapore )</h5>
                                            <p class="reviewName">Enatyam's yoga is a perfect fit for a busy mom like me. The quick sessions are manageable, and the instructors make it feel like a mini wellness retreat. Grateful for this accessible and effective platform!</p>
                                        </div>
                        ...
                        <div class="item">
                            <div class="item in" >
                                    <div class="happyFaces-div">
                                        <div class="happyFaces-div1 ">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/8.png"  alt="weightloss77" class="centered-image" />
                                        <div class="hft">
                                            <h5>Rajiv ( Lucknow )</h5>
                                            <p class="reviewName">The variety of yoga classes on Enatyam is impressive. Whether I need a gentle stretch or an energizing flow, there's something for every mood. The instructors make it easy for anyone to enjoy the benefits of yoga.</p>
                                        </div>
                        ...
                        <div class="item"> 
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/9.png" alt="weightloss78" class="centered-image" />
                                        <div class="hft">
                                        <h5>Vikram ( Delhi )</h5>
                                        <p class="reviewName">Enatyam's yoga classes have made me realize that yoga is for everyone. The inclusive approach of the instructors and the straightforward guidance make it a comfortable and enjoyable practice.</p>
                                        </div>
                        ...
                        <div class="item">
                            ...
                            <!-- Your content here -->
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 ">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/5.png" alt="weightloss79" class="centered-image" />
                                        <div class="hft">
                                            <h5>Unnikrishnan (Dubai)</h5>
                                            <p class="reviewName">Enatyam's yoga courses are my go-to for stress relief. The calming voice of the instructors and the simplicity of the poses make it a perfect escape from the chaos of daily life.</p>
                                        </div>
                    ...
                    <div class="item"> 
                        <div class="item in" >
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 mb-5">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/11h.webp" alt="weightloss80" class="centered-image" />
                                    <div class="hft">
                                        <h5>Kajal ( Delhi )</h5>
                                        <p class="reviewName">I appreciate how Enatyam's yoga classes cater to various levels. Whether you're a beginner or an experienced yogi, there's always room for growth. The instructors make sure everyone feels welcome. </p>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <!-- Your content here -->
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 ">
                                <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/14.png" alt="weightloss81" class="centered-image" />
                                    <div class="hft">
                                        <h5>Scarlett family ( Germany )</h5>
                                        <p class="reviewName">Yoga is a daily dose of positivity for me . The instructors radiate good vibes, and the classes have become my source of calm in the midst of a busy schedule. A fantastic platform for holistic well-being!</p>
                                    </div>
                    ...
                    <div class="item"> 
                        <div class="item in" >
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 mb-5">
                                <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/7.png" alt="weightloss82" class="centered-image" />
                                    <div class="hft">
                                        <h5>Emma ( UK )</h5>
                                        <p class="reviewName">Yoga is my daily escape from the hustle. The instructors make it easy to disconnect and focus on the present moment. It's a simple yet powerful practice that has become a non-negotiable in my routine.</p>
                                    </div>
                    ...
                    <div class="item">
                        <div class="item in" >
                            <!-- Your content here -->
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 ">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/11.png" alt="weightloss83" class="centered-image" />
                                    <div class="hft">
                                        <h5>Michael (Mike) ( USA)</h5>
                                        <p class="reviewName">Enatyam's yoga is like a personal wellness retreat at home. The instructors create a serene atmosphere, and the classes feel like a journey into both physical and mental well-being. Truly transformative</p>
                                    </div>
