        ...
        <div class="col-lg-12 col-md-12 col-12 p-5 mt-5" style="background-color: black;">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-12 textPara-col kathakp">
                        <h2 class="heading text-white">Explore the Melodic World of the Flute</h2>
                        <p class="text-white">
                        Immerse yourself in the enchanting sounds of the flute, an instrument known for its sweet, lyrical tones and versatility across various music genres. Whether you're a beginner or an experienced musician, the flute offers a captivating journey into the world of music.                        </p>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 textPara-col kathakp">
                        <img src="public/images/Instrument/fluteImg1.svg" class="rightimg" alt="Yoga Class" style="width:100%;">
                    </div>
                </div>
            </div>
        </div>
