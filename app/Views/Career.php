...
<script type="module" src="<?php echo base_url();?>public/js/countryCodes.js"></script>
<script>
...
// import countryCodes from 'public/js/countryCodes.js';
// E:\xampp\htdocs\enatyam\public\js\countryCodes.js
window.addEventListener("DOMContentLoaded", (event) => {
    console.log("DOM fully loaded and parsed");
    let details = [{
            "code": "N.A.",
...
//         let txtOption = '<option value="' + countryCodes[i]['phone'] + '"' + ' data-phonelength="' + countryCodes[i]['data-phoneLength'] + '">' + countryCodes[i]['label'] + '</option>';
//         dropDown.innerHTML = dropDown.innerHTML + txtOption;
//     }
// });
...
//     careerMobileNo.minLength = event.target.options[event.target.selectedIndex].dataset.phonelength
//     careerMobileNo.maxLength = event.target.options[event.target.selectedIndex].dataset.phonelength
//     careerMobileNo.placeholder = "limit: " + event.target.options[event.target.selectedIndex].dataset.phonelength +
//         " characters"
// })
