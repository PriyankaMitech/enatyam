            ...
            <div class="col-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Students Images</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                ...
                                ?>
                                        <div class="col-sm-3 mt-3">
                                            <div class="position-relative videoofs card">
                                                ...
                                                <?php $imagePath = '/public/uploads/images/studentUploadedImages/' . $data->name;
