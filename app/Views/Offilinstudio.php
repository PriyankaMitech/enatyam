...
<section class="offiline-section ">
    <div class="container">
        <div class="row">
            ...
            <form class="offlineStudioform" action="<?php echo base_url(); ?>offlineAddress" method="post"
                id="offlineStudioform">
                <div class="col-md-12 col-12 text-col mt-5 text-center">
                    ...
                    <div class="text-center offlinei">
                        <input type="text" class="form-control mr-sm-2 small-input" name="pincode" id="pincodeAdress"
                            placeholder="pincode" title="Please enter maximum 6 digits">
                        <span id="pincodeError" class="text-danger" style="display: none;">Please enter a valid pin
                            code.</span>
