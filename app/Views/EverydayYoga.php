        ...
        <div class="col-lg-12 col-md-12 col-12 p-5" style="background-color: black;">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-12 textPara-col kathakp">
                        <h2 class="heading text-white">Start Your Daily Yoga Journey Today!</h2>
                        <p class="text-white">
                        Transform your daily routine with the enriching practice of yoga. Enroll in our Everyday Yoga course and experience the benefits of a consistent, holistic approach to health and well-being. Start each day with a clear mind and focused intention.                       </p>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 textPara-col kathakp">
                        <img src="<?=base_url(); ?>public/images/Yoga/everydayyoga.jpeg" class="rightimg" alt="Yoga Class" style="width:100%;">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="">
                    ...
                    <div class="col-lg-12 col-md-12 col-12 coh">
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            ...
                            <div class="ThumbnailImg " style="text-align: center;">
                                <a href="<?= base_url(); ?>online-customise-your-plan" target="" class="d-block h-100">
                                    <img class="img-fluid img-thumbnail"
    ...
    <div class="container dancepagec">
        <div class="typesOfYoga-tab">
            ...
            <ul class="row nav nav-pills mb-3" id="pills-tab" role="tablist">
                ...
                <li class="col-lg-2 col-md-2 col-6 nav-item" role="presentation">
                    <a class="nav-link active" id="pills-EverydayYoga-tab" href="<?=base_url(); ?>EverydayYoga" data-url="<?=base_url(); ?>EverydayYoga" role="tab" aria-controls="pills-EverydayYoga" aria-selected="false">Everyday Yoga</a>
                </li>
                <li class="col-lg-1 col-md-1 hidey">
                </li>
                <li class="col-lg-1 col-md-1 hidey">
            ...
            <div class="tab-content " id="pills-tabContent">
                ...
                <div class="tab-pane fade show active" id="pills-PrenatalYoga" role="tabpanel" aria-labelledby="pills-PrenatalYoga-tab">
                    ...
                    <img src="<?=base_url(); ?>public/images/boarder1.webp" alt="Image Description" class="img-fluid">
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/EverydayYoga.svg" alt="EverydayYoga" class="danceimg">
                        </div>
                        ...
                        <div class="container">
                            <div class="row ">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="EverydayYoga1" class="danceimg">
                            ...
                            <div class="month-row">
                                ...
                                <div class="col-lg-12 col-12 text-center testimonialsdiv">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg" alt="EverydayYoga10" class="danceimgy">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="EverydayYoga11">
                                                    Live Private class -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="EverydayYoga12">
                                                    Practice video -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp" alt="EverydayYoga13">
                ...
                <div class="tab-pane fade" id="pills-StressReduction" role="tabpanel" aria-labelledby="pills-StressReduction-tab">
                    <div class="row pddyd">
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/StressReductionImg.svg"  alt="EverydayYoga14" class="danceimg">
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg"  alt="EverydayYoga15" class="danceimg">
                        ...
                        <div class="container">
                            ...
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg" alt="EverydayYoga16" class="danceimgy">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp"alt="EverydayYoga17">
                                                    Live Private class -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="EverydayYoga18">
                                                    Practice video -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp"  alt="EverydayYoga19">
                                                    Reading content/Quiz - 2
                                                </div>
                                                <div class="module-text">
                ...
                <div class="tab-pane fade show" id="pills-Flexibility" role="tabpanel" aria-labelledby="pills-Flexibility-tab">
                    <div class="row pddyd">
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/FlexibilityYogaImg.svg" alt="EverydayYoga20" class="danceimg">
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="EverydayYoga21" class="danceimg">
                        ...
                        <div class="container">
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg" alt="EverydayYoga22" class="danceimgy">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="EverydayYoga23">
                                                    Live Private class -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="EverydayYoga24">
                                                    Practice video -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp" alt="EverydayYoga25">
                                                    Reading content/Quiz - 2
                                                </div>
                ...
                <div class="tab-pane fade show" id="pills-WeightLossYoga" role="tabpanel" aria-labelledby="pills-WeightLossYoga-tab">
                    <div class="row pddyd">
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/WeightLossYogaImg.svg" alt="EverydayYoga26" class="danceimg">
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                    ...
                    <section class="learningsec yellowb" id="learnyoga3">
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <!-- <div class="chgimg" > -->
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="EverydayYoga27"class="danceimg">
                                </div>
                            </div>
                        </div>
                    </section>
                        ...
                        <div class="container">
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg" alt="EverydayYoga28" class="danceimgy">
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-12">
                                        <!-- trying new tab  -->
                                        <ul class="row nav nav-pills mb-3" id="pills-tab" role="tablist">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp"alt="EverydayYoga29">
                                                    Live Private class -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="EverydayYoga30">
                                                    Practice video -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp"alt="EverydayYoga31">
                                                    Reading content/Quiz - 2
                                                </div>
                ...
                <div class="tab-pane fade show" id="pills-EverydayYoga" role="tabpanel" aria-labelledby="pills-EverydayYoga-tab">
                    <div class="row pddyd">
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/EverydayYoga.svg" alt="EverydayYoga32" class="danceimg">
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                            <h3 class="heading"> Everyday Yoga</h3>
                            <p class="">
                        ...
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="EverydayYoga33" class="danceimg">
                        ...
                        <div class="container">
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg" alt="EverydayYoga34" class="danceimgy">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp"alt="EverydayYoga35">
                                                    Live Private class -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp"alt="EverydayYoga36">
                                                    Practice video -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp" alt="EverydayYoga37">
                                                    Reading content/Quiz - 2
                                                </div>
                ...
                <div class="tab-pane fade show" id="pills-YogaforChronic" role="tabpanel" aria-labelledby="pills-YogaforChronic-tab">
                    <div class="row pddyd">
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/chronicYoga.svg" alt="EverydayYoga38" class="danceimg">
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="EverydayYoga39" class="danceimg">
                        ...
                        <div class="container">
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg" alt="EverydayYoga40" class="danceimgy">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="EverydayYoga41">
                                                    Live Private class -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="EverydayYoga42">
                                                    Practice video -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp" alt="EverydayYoga43">
                                                    Reading content/Quiz - 2
                                                </div>
                ...
                <div class="tab-pane fade show" id="pills-YogaforKids" role="tabpanel" aria-labelledby="pills-YogaforKids-tab">
                    <div class="row pddyd">
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/YogaforKids.svg" alt="EverydayYoga44" class="danceimg">
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="EverydayYoga45" class="danceimg">
                        ...
                        <div class="container">
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg"  alt="EverydayYoga46" class="danceimgy">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="EverydayYoga47">
                                                    Live Private class -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="EverydayYoga48">
                                                    Practice video -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp" alt="EverydayYoga49">
                                                    Reading content/Quiz - 2
                                                </div>
                ...
                <div class="tab-pane fade show" id="pills-Meditation" role="tabpanel" aria-labelledby="pills-Meditation-tab">
                    <div class="row pddyd">
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/MeditationImg.svg" alt="EverydayYoga50" class="danceimg">
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="EverydayYoga51" class="danceimg">
                ...
                <div class="tab-pane fade show" id="pills-CustomiseYoga" role="tabpanel" aria-labelledby="pills-CustomiseYoga-tab">
                    <div class="row pddyd">
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/CustomizeYogaImg.svg" alt="EverydayYoga52" class="danceimg">
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="EverydayYoga53" class="danceimg">
                        ...
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg"  alt="EverydayYoga54" class="danceimg">
                        ...
                        <div class="container">
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg" alt="EverydayYoga55" class="danceimgy">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="EverydayYoga56">
                                                    Live Private class -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="EverydayYoga57">
                                                    Practice video -2
                                                </div>
                                                <div class="content"> 
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp" alt="EverydayYoga58">
                                                    Reading content/Quiz - 2
                                                </div>
                ...
                <div class="owl-carousel owl-theme">
                        <div class="item">
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/1.png" alt="EverydayYoga60" class="centered-image" />
                                            <div class="hft">
                            ...
                            <div class="item in" >
                                    <div class="happyFaces-div">
                                        <div class="happyFaces-div1 mb-5">
                                            <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/2.png" alt="EverydayYoga61" class="centered-image"  />
                                            <div class="hft">
                        ...
                        <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/3.png" alt="EverydayYoga62" class="centered-image" />
                                        <div class="hft">
                                            <h5>Sneha (Canada )</h5>
                            ...
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 ">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/4.png" alt="EverydayYoga63" class="centered-image" />
                                        <div class="hft">
                                            <h5>Kavita ( Pune)</h5>
                        ...
                        <div class="item">
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/6.png" alt="EverydayYoga64" class="centered-image" />
                                        <div class="hft">
                            ...
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 ">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/8.png" alt="EverydayYoga65" class="centered-image" />
                                        <div class="hft">
                                            <h5>Rajiv ( Lucknow )</h5>
                        ...
                        <div class="item"> 
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/9.png" alt="EverydayYoga66" class="centered-image" />
                            ...
                            <!-- Your content here -->
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 ">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/5.png"  alt="EverydayYoga67" class="centered-image" />
                                        <div class="hft">
                    ...
                    <div class="item"> 
                        <div class="item in" >
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 mb-5">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/13.png" alt="EverydayYoga68" class="centered-image" />
                                    <div class="hft">
                                        <h5>Kajal ( Delhi )</h5>
                        ...
                        <!-- Your content here -->
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 ">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/14.png" alt="EverydayYoga69" class="centered-image" />
                                    <div class="hft">
                    ...
                    <div class="item"> 
                        <div class="item in" >
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 mb-5">
                                <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/7.png" alt="EverydayYoga70" class="centered-image" />
                                    <div class="hft">
                                        <h5>Emma ( UK )</h5>
                        ...
                        <!-- Your content here -->
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 ">
                                <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/11.png" alt="EverydayYoga71" class="centered-image" />
                                    <div class="hft">
                ...
                <div class="owl-carousel owl-theme">
                        <div class="item">
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/1.png" alt="EverydayYoga72" class="centered-image" />
                                            <div class="hft">
                                                <h5>Aiden C ( London -Uk)</h5>
                                                <p>Enatyam's yoga courses are a total game-changer for me. The instructors keep it real, making every pose feel achievable. It's like having a personal yoga guide right in my living room.
                                                </p>
                        ...
                        <div class="item">
                            <div class="item in" >
                                    <div class="happyFaces-div">
                                        <div class="happyFaces-div1 mb-5">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/2.png" alt="EverydayYoga73" class="centered-image"  />
                                            <div class="hft">
                                                <h5>Sweta ( Australia)</h5>
                                                <p>I'm new to yoga, and Enatyam is the perfect starting point. The classes are not intimidating, and the instructors break down each pose in a way that's easy to understand. Feeling more zen already!</p>
                                            </div>
                        ...
                        <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                     <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/3.png" alt="EverydayYoga74" class="centered-image" />
                                        <div class="hft">
                                            <h5>Sneha (Canada )</h5>
                                        <p class="reviewName">Enatyam's yoga classes are like a breath of fresh air. The instructors create a friendly atmosphere, making the sessions enjoyable. It's become a daily ritual that I genuinely look forward to.</p>
                                        </div>
                        ...
                        <div class="item">
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 ">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/4.png" alt="EverydayYoga75" class="centered-image" />
                                        <div class="hft">
                                            <h5>Kavita ( Pune)</h5>
                                            <p class="reviewName">I've tried a few online yoga platforms, but Enatyam stands out. The variety of classes keeps things interesting, and the instructors feel like friends guiding you through a mindful journey. Highly recommend!</p>
                                        </div>
                        ...
                        <div class="item">
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/6.png" alt="EverydayYoga77" class="centered-image" />
                                        <div class="hft">
                                            <h5>Ayesha ( Singapore )</h5>
                                            <p class="reviewName">Enatyam's yoga is a perfect fit for a busy mom like me. The quick sessions are manageable, and the instructors make it feel like a mini wellness retreat. Grateful for this accessible and effective platform!</p>
                                        </div>
                        ...
                        <div class="item">
                            <div class="item in" >
                                    <div class="happyFaces-div">
                                        <div class="happyFaces-div1 ">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/8.png"  alt="EverydayYoga78" class="centered-image" />
                                        <div class="hft">
                                            <h5>Rajiv ( Lucknow )</h5>
                                            <p class="reviewName">The variety of yoga classes on Enatyam is impressive. Whether I need a gentle stretch or an energizing flow, there's something for every mood. The instructors make it easy for anyone to enjoy the benefits of yoga.</p>
                                        </div>
                        ...
                        <div class="item"> 
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/9.png" alt="EverydayYoga79" class="centered-image" />
                                        <div class="hft">
                                        <h5>Vikram ( Delhi )</h5>
                                        <p class="reviewName">Enatyam's yoga classes have made me realize that yoga is for everyone. The inclusive approach of the instructors and the straightforward guidance make it a comfortable and enjoyable practice.</p>
                                        </div>
                        ...
                        <div class="item">
                            ...
                            <!-- Your content here -->
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 ">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/5.png" alt="EverydayYoga80" class="centered-image" />
                                        <div class="hft">
                                            <h5>Unnikrishnan (Dubai)</h5>
                                            <p class="reviewName">Enatyam's yoga courses are my go-to for stress relief. The calming voice of the instructors and the simplicity of the poses make it a perfect escape from the chaos of daily life.</p>
                                        </div>
                    ...
                    <div class="item"> 
                        <div class="item in" >
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 mb-5">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/11h.webp" alt="EverydayYoga81" class="centered-image" />
                                    <div class="hft">
                                        <h5>Kajal ( Delhi )</h5>
                                        <p class="reviewName">I appreciate how Enatyam's yoga classes cater to various levels. Whether you're a beginner or an experienced yogi, there's always room for growth. The instructors make sure everyone feels welcome. </p>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <!-- Your content here -->
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 ">
                                <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/14.png" alt="EverydayYoga82" class="centered-image" />
                                    <div class="hft">
                                        <h5>Scarlett family ( Germany )</h5>
                                        <p class="reviewName">Yoga is a daily dose of positivity for me . The instructors radiate good vibes, and the classes have become my source of calm in the midst of a busy schedule. A fantastic platform for holistic well-being!</p>
                                    </div>
                    ...
                    <div class="item"> 
                        <div class="item in" >
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 mb-5">
                                <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/7.png" alt="EverydayYoga83" class="centered-image" />
                                    <div class="hft">
                                        <h5>Emma ( UK )</h5>
                                        <p class="reviewName">Yoga is my daily escape from the hustle. The instructors make it easy to disconnect and focus on the present moment. It's a simple yet powerful practice that has become a non-negotiable in my routine.</p>
                                    </div>
                    ...
                    <div class="item">
                        <div class="item in" >
                            <!-- Your content here -->
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 ">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/11.png" alt="EverydayYoga84" class="centered-image" />
                                    <div class="hft">
                                        <h5>Michael (Mike) ( USA)</h5>
                                        <p class="reviewName">Enatyam's yoga is like a personal wellness retreat at home. The instructors create a serene atmosphere, and the classes feel like a journey into both physical and mental well-being. Truly transformative</p>
                                    </div>
