    ...
    <div class="container-fluid letter">
        <div class="row invoice-header">
            ...
            <div class="col-lg-4 logo-container mt-3 ss order-lg-last">
                <img src="public/images/logos.png" alt="Enatyam" class="img-fluid sp">
                <p class="mt-3">Invoice Date: [Date]<br></p>
        ...
        <div class="row bill-to mt-4">
            <div class="col">
                ...
                <p>INVOICE TO:<br><b><?php echo $fullname; ?></b><br>Mobile No :<?php echo $mobile; ?><br>Adress:<br>
                </p>
            </div>
        </div>
        <div class="row">
