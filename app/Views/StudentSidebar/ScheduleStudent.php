        ...
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <?php if (!empty($buttonText)) : ?>
                    <button class="btn btn-sm btn-primary float-right" onclick="openModal('<?= $currentDate ?>', <?= $i + 1 ?>, '<?= $buttonText ?>')"> <?= $buttonText ?> </button>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<form action="SessionConduct" method="post">
    <div id="myModal" class="modal">
        <div class="modal-content">
            ...
            <p><button type="submit" name="conduct" value="S" class="btn btn-block btn-success">Success</button></p><br>
            <p><button type="submit" name="conduct" value="N" class="btn btn-block btn-danger">Not Conducted</button></p>
        </div>
    </div>
</form>
        </div>
