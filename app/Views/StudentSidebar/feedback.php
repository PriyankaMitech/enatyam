        ...
        <div class="col-md-4">
          <div class="card card-widget widget-user-2 shadow">
            <div class="widget-user-header bg-warning">
              ...
              <h3 class="widget-user-username"><?php if (!empty($alldataoff)) {
                                                  echo $alldataoff->faculty_name;
                                                } ?></h3>
              <h5 class="widget-user-desc"><?php if (!empty($alldatac)) {
                                              echo $alldatac->course;
                                            } ?></h5>
            </div>
            <div class="card-footer p-0">
              <ul class="nav flex-column">
                <form id="feedbackform" method="post">
                  ...
                  <input type="hidden" name="faculty_id" id="faculty_id" value="<?php if (!empty($alldataoff)) {
                                                                                  echo $alldataoff->faculty_id;
                                                                                } ?>">
                  <li class="nav-item p-4">
                    <select class='rating text-center' name="rating" id='faculty<?php //echo $rate['average_ue']; 
                                                                                ?>' data-id='rating_ue_<?php //echo $rate['average_ue']; 
                                                                                                                                          ?>'>
