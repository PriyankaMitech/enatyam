                ...
                <ul class="nav flex-column">
                  <form action="#" id="feedbackform" method="post">
                    <li class="nav-item p-4">
                      <select class='rating text-center' name="faculty" id='faculty<?php //echo $rate['average_ue']; ?>' data-id='rating_ue_<?php //echo $rate['average_ue']; ?>'>
                      ...
                      <input type="hidden" name="faculty_id" value="2">
