        ...
        <div class="col-lg-12 col-md-12 col-12 p-5" style="background-color: black;">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-12 textPara-col kathakp">
                        <h2 class="heading text-white">Enhance Your Flexibility with Our Yoga Course</h2>
                        <p class="text-white">
                        A mix of movements to warm up muscles and deep <br> stretches for lasting flexibility. Take the first step <br> towards a more flexible and healthier you. Enroll in our <br>Flexibility Yoga course and experience the benefits of improved mobility and strength.                        </p>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 textPara-col kathakp">
                        <img src="<?=base_url(); ?>public/images/Yoga/flexibility.jpeg" class="rightimg" alt="Yoga Class" style="width:100%;">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="typesOfYoga-tab">
            ...
            <div class="tab-content " id="pills-tabContent">
                ...
                <div class="tab-pane fade show active" id="pills-PrenatalYoga" role="tabpanel" aria-labelledby="pills-PrenatalYoga-tab">
                    ...
                    <img src="<?=base_url(); ?>public/images/boarder1.webp" alt="Image Description" class="img-fluid">
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/FlexibilityYogaImg.svg" alt="flexibility1" class="danceimg">
                        </div>
                        ...
                        <div class="container">
                            <div class="row ">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="flexibility2" class="danceimg">
                            ...
                            <div class="month-row">
                                ...
                                <div class="col-lg-12 col-12 text-center testimonialsdiv">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg" alt="flexibility3" class="danceimgy">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="flexibility4">
                                                    Live Private class -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="flexibility5">
                                                    Practice video -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp" alt="flexibility6">
                        ...
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="flexibility11" class="danceimg">
                        ...
                        <div class="container">
                            ...
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg" alt="flexibility12" class="danceimgy">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="flexibility13">
                                                    Live Private class -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp"alt="flexibility14">
                                                    Practice video -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp"alt="flexibility15">
                                                    Reading content/Quiz - 2
                                                </div>
                                                <div class="module-text">
                ...
                <div class="tab-pane fade show" id="pills-Flexibility" role="tabpanel" aria-labelledby="pills-Flexibility-tab">
                    <div class="row pddyd">
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/FlexibilityYogaImg.svg" alt="flexibility16" class="danceimg">
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                            <h3 class="heading"> Flexibility Yoga</h3>
                            <p class="">
                        ...
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="flexibility17" class="danceimg">
                        ...
                        <div class="container">
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg" alt="flexibility18" class="danceimgy">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="flexibility19">
                                                    Live Private class -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="flexibility20">
                                                    Practice video -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp" alt="flexibility21">
                                                    Reading content/Quiz - 2
                                                </div>
                ...
                <div class="tab-pane fade show" id="pills-WeightLossYoga" role="tabpanel" aria-labelledby="pills-WeightLossYoga-tab">
                    <div class="row pddyd">
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/WeightLossYogaImg.svg" alt="flexibility22" class="danceimg">
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                    ...
                    <section class="learningsec yellowb" id="learnyoga3">
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <!-- <div class="chgimg" > -->
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="flexibility23" class="danceimg">
                                </div>
                            </div>
                        </div>
                    </section>
                        ...
                        <div class="container">
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg" alt="flexibility24" class="danceimgy">
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-12">
                                        <!-- trying new tab  -->
                                        <ul class="row nav nav-pills mb-3" id="pills-tab" role="tablist">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="flexibility25">
                                                    Live Private class -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="flexibility26">
                                                    Practice video -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp" alt="flexibility27">
                                                    Reading content/Quiz - 2
                                                </div>
                ...
                <div class="tab-pane fade show" id="pills-EverydayYoga" role="tabpanel" aria-labelledby="pills-EverydayYoga-tab">
                    <div class="row pddyd">
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/EverydayYoga.svg" alt="flexibility28" class="danceimg">
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="flexibility29" class="danceimg">
                        ...
                        <div class="container">
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg" alt="flexibility30" class="danceimgy">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="flexibility31">
                                                    Live Private class -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="flexibility32">
                                                    Practice video -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp" alt="flexibility33">
                                                    Reading content/Quiz - 2
                                                </div>
                ...
                <div class="tab-pane fade show" id="pills-YogaforChronic" role="tabpanel" aria-labelledby="pills-YogaforChronic-tab">
                    <div class="row pddyd">
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/chronicYoga.svg" alt="flexibility34" class="danceimg">
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="flexibility35" class="danceimg">
                        ...
                        <div class="container">
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg" alt="flexibility36" class="danceimgy">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="flexibility37">
                                                    Live Private class -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="flexibility38">
                                                    Practice video -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp" alt="flexibility39">
                                                    Reading content/Quiz - 2
                                                </div>
                ...
                <div class="tab-pane fade show" id="pills-YogaforKids" role="tabpanel" aria-labelledby="pills-YogaforKids-tab">
                    <div class="row pddyd">
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/YogaforKids.svg" alt="flexibility40" class="danceimg">
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="flexibility41" class="danceimg">
                        ...
                        <div class="container">
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg" alt="flexibility42" class="danceimgy">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="flexibility43">
                                                    Live Private class -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="flexibility44">
                                                    Practice video -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp"alt="flexibility45">
                                                    Reading content/Quiz - 2
                                                </div>
                ...
                <div class="tab-pane fade show" id="pills-Meditation" role="tabpanel" aria-labelledby="pills-Meditation-tab">
                    <div class="row pddyd">
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/MeditationImg.svg" alt="flexibility46" class="danceimg">
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="flexibility47" class="danceimg">
                        ...
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="flexibility48" class="danceimg">
                ...
                <div class="tab-pane fade show" id="pills-NutritionCounselling" role="tabpanel" aria-labelledby="pills-NutritionCounselling-tab">
                    <div class="row pddyd">
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/NutritionCounsellingImg.svg" alt="flexibility49" class="danceimg">
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <div class="container">
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="flexibility5" class="danceimg">
                        ...
                        <div class="container">
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg" alt="flexibility51" class="danceimgy">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        ...
                                        <div class="contentSec">
                                            <div class="">
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="flexibility52">
                                                    Live Private class -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8.webp" alt="flexibility53">
                                                    Practice video -2
                                                </div>
                                                <div class="content">
                                                    <img src="<?=base_url(); ?>public/images/Dance/icons8-literature.webp"alt="flexibility54">
                                                    Reading content/Quiz - 2
                                                </div>
                ...
                <div class="owl-carousel owl-theme">
                        <div class="item">
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/1.png" alt="flexibility55" class="centered-image" />
                                            <div class="hft">
                            ...
                            <div class="item in" >
                                    <div class="happyFaces-div">
                                        <div class="happyFaces-div1 mb-5">
                                            <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/2.png" alt="flexibility56" class="centered-image"  />
                                            <div class="hft">
                        ...
                        <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/3.png" alt="flexibility57" class="centered-image" />
                                        <div class="hft">
                                            <h5>Sneha (Canada )</h5>
                            ...
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 ">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/4.png" alt="flexibility58" class="centered-image" />
                                        <div class="hft">
                                            <h5>Kavita ( Pune)</h5>
                        ...
                        <div class="item">
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/6.png" alt="flexibility59" class="centered-image" />
                                        <div class="hft">
                            ...
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 ">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/8.png" alt="flexibility60" class="centered-image" />
                                        <div class="hft">
                                            <h5>Rajiv ( Lucknow )</h5>
                        ...
                        <div class="item"> 
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/9.png" alt="flexibility61" class="centered-image" />
                            ...
                            <!-- Your content here -->
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 ">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/5.png" alt="flexibility62" class="centered-image" />
                                        <div class="hft">
                    ...
                    <div class="item"> 
                        <div class="item in" >
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 mb-5">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/13.png"  alt="flexibility63" class="centered-image" />
                                    <div class="hft">
                                        <h5>Kajal ( Delhi )</h5>
                        ...
                        <!-- Your content here -->
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 ">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/14.png" alt="flexibility64" class="centered-image" />
                                    <div class="hft">
                    ...
                    <div class="item"> 
                        <div class="item in" >
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 mb-5">
                                <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/7.png" alt="flexibility65" class="centered-image" />
                                    <div class="hft">
                                        <h5>Emma ( UK )</h5>
                        ...
                        <!-- Your content here -->
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 ">
                                <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/11.png" alt="flexibility66" class="centered-image" />
                                    <div class="hft">
                ...
                <div class="owl-carousel owl-theme">
                        <div class="item">
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/1.png" alt="flexibility67" class="centered-image" />
                                            <div class="hft">
                                                <h5>Aiden C ( London -Uk)</h5>
                                                <p>Enatyam's yoga courses are a total game-changer for me. The instructors keep it real, making every pose feel achievable. It's like having a personal yoga guide right in my living room.
                                                </p>
                        ...
                        <div class="item">
                            <div class="item in" >
                                    <div class="happyFaces-div">
                                        <div class="happyFaces-div1 mb-5">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/2.png" alt="flexibility68" class="centered-image"  />
                                            <div class="hft">
                                                <h5>Sweta ( Australia)</h5>
                                                <p>I'm new to yoga, and Enatyam is the perfect starting point. The classes are not intimidating, and the instructors break down each pose in a way that's easy to understand. Feeling more zen already!</p>
                                            </div>
                        ...
                        <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                     <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/3.png" alt="flexibility69" class="centered-image" />
                                        <div class="hft">
                                            <h5>Sneha (Canada )</h5>
                                        <p class="reviewName">Enatyam's yoga classes are like a breath of fresh air. The instructors create a friendly atmosphere, making the sessions enjoyable. It's become a daily ritual that I genuinely look forward to.</p>
                                        </div>
                        ...
                        <div class="item">
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 ">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/4.png" alt="flexibility70" class="centered-image" />
                                        <div class="hft">
                                            <h5>Kavita ( Pune)</h5>
                                            <p class="reviewName">I've tried a few online yoga platforms, but Enatyam stands out. The variety of classes keeps things interesting, and the instructors feel like friends guiding you through a mindful journey. Highly recommend!</p>
                                        </div>
                        ...
                        <div class="item">
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/6.png" alt="flexibility71"  class="centered-image" />
                                        <div class="hft">
                                            <h5>Ayesha ( Singapore )</h5>
                                            <p class="reviewName">Enatyam's yoga is a perfect fit for a busy mom like me. The quick sessions are manageable, and the instructors make it feel like a mini wellness retreat. Grateful for this accessible and effective platform!</p>
                                        </div>
                        ...
                        <div class="item">
                            <div class="item in" >
                                    <div class="happyFaces-div">
                                        <div class="happyFaces-div1 ">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/8.png"  alt="flexibility72" class="centered-image" />
                                        <div class="hft">
                                            <h5>Rajiv ( Lucknow )</h5>
                                            <p class="reviewName">The variety of yoga classes on Enatyam is impressive. Whether I need a gentle stretch or an energizing flow, there's something for every mood. The instructors make it easy for anyone to enjoy the benefits of yoga.</p>
                                        </div>
                        ...
                        <div class="item"> 
                            <div class="item in" >
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 mb-5">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/9.png" alt="flexibility73"  class="centered-image" />
                                        <div class="hft">
                                        <h5>Vikram ( Delhi )</h5>
                                        <p class="reviewName">Enatyam's yoga classes have made me realize that yoga is for everyone. The inclusive approach of the instructors and the straightforward guidance make it a comfortable and enjoyable practice.</p>
                                        </div>
                        ...
                        <div class="item">
                            ...
                            <!-- Your content here -->
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 ">
                                        <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/5.png" alt="flexibility74"  class="centered-image" />
                                        <div class="hft">
                                            <h5>Unnikrishnan (Dubai)</h5>
                                            <p class="reviewName">Enatyam's yoga courses are my go-to for stress relief. The calming voice of the instructors and the simplicity of the poses make it a perfect escape from the chaos of daily life.</p>
                                        </div>
                    ...
                    <div class="item"> 
                        <div class="item in" >
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 mb-5">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/11h.webp" alt="flexibility75"  class="centered-image" />
                                    <div class="hft">
                                        <h5>Kajal ( Delhi )</h5>
                                        <p class="reviewName">I appreciate how Enatyam's yoga classes cater to various levels. Whether you're a beginner or an experienced yogi, there's always room for growth. The instructors make sure everyone feels welcome. </p>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <!-- Your content here -->
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 ">
                                <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/14.png" alt="flexibility76"  class="centered-image" />
                                    <div class="hft">
                                        <h5>Scarlett family ( Germany )</h5>
                                        <p class="reviewName">Yoga is a daily dose of positivity for me . The instructors radiate good vibes, and the classes have become my source of calm in the midst of a busy schedule. A fantastic platform for holistic well-being!</p>
                                    </div>
                    ...
                    <div class="item"> 
                        <div class="item in" >
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 mb-5">
                                <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/7.png" alt="flexibility77"  class="centered-image" />
                                    <div class="hft">
                                        <h5>Emma ( UK )</h5>
                                        <p class="reviewName">Yoga is my daily escape from the hustle. The instructors make it easy to disconnect and focus on the present moment. It's a simple yet powerful practice that has become a non-negotiable in my routine.</p>
                                    </div>
                    ...
                    <div class="item">
                        <div class="item in" >
                            <!-- Your content here -->
                                <div class="happyFaces-div">
                                    <div class="happyFaces-div1 ">
                                    <img src="<?=base_url(); ?>public/images/happyfaces/Yoga/11.png" alt="flexibility78"  class="centered-image" />
                                    <div class="hft">
                                        <h5>Michael (Mike) ( USA)</h5>
                                        <p class="reviewName">Enatyam's yoga is like a personal wellness retreat at home. The instructors create a serene atmosphere, and the classes feel like a journey into both physical and mental well-being. Truly transformative</p>
                                    </div>
