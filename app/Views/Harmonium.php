        ...
        <div class="col-lg-12 col-md-12 col-12 p-5 mt-5" style="background-color: black;">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-12 textPara-col kathakp">
                        ...
                        <p class="text-white">
                        The harmonium, an essential instrument in many musical traditions, is celebrated for its rich, melodious tones and versatility. Commonly used in Indian classical, devotional, and folk music, the harmonium offers a unique blend of sustained notes and vibrant chords.                        </p>
                    ...
                    <div class="col-lg-6 col-md-6 col-12  textPara-col kathakp" >
                        <img src="public/images/Instrument/Harmonium.jpeg" class="rightimg" alt="Yoga Class" style="width:100%;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container dancepagec">
        <div class="typesOfYoga-tab">
            <!-- <ul class="row nav nav-pills mb-3" id="pills-tab" role="tablist">
                ...
                <li class="col-lg-2 col-md-2 col-6 nav-item" role="presentation">
                    <a class="nav-link active" id="pills-Harmonium-tab" href="<?=base_url(); ?>Harmonium" data-url="<?=base_url(); ?>Harmonium" role="tab" aria-controls="pills-Harmonium" aria-selected="false">Harmonium</a>
                </li>
