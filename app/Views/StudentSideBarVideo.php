...
<head>
    ...
    <title>Uploded Video</title>

    <?php include(APPPATH . 'views/StudentSidebar/Studentsidebar.php'); ?>

    <style>
        /* Add a hover effect on the video card */
        .video-card:hover {
        ...
        /* Style the card body (you can customize these styles) */
                ...
                <?php foreach ($videos as $video) : ?>
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <!-- C:\xampp\htdocs\enatyam\writable\uploads\sample.mp4 -->
                            <!-- C:\xampp\htdocs\enatyam\public\uploads\FacultyUplodedVideos -->
