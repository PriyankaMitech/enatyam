        ...
        <div class="col-lg-12 col-md-12 col-12 p-5 mt-5" style="background-color: black;">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-12 textPara-col kathakp">
                        <h2 class="heading text-white">The Versatile World of the Keyboard</h2>
                        <p class="text-white">
                        Learning to play the keyboard enhances musical understanding, improves hand-eye coordination, and fosters creativity. With its portability and adaptability, the keyboard is perfect for solo performances, band settings, and even composing music.                        </p>
                    ...
                    <div class="col-lg-6 col-md-6 col-12  textPara-col kathakp" >
                        <img src="<?php echo  base_url(); ?>public/images/instrument/Keyboard.jpeg" class="rightimg" alt="Yoga Class" style="width:100%;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container dancepagec">
        <div class="typesOfYoga-tab">
            <!-- <ul class="row nav nav-pills mb-3" id="pills-tab" role="tablist">
                ...
                <li class="col-lg-2 col-md-2 col-6 nav-item" role="presentation">
                    <a class="nav-link active" id="pills-Keyboard-tab" href="<?=base_url(); ?>Keyboard" data-url="<?=base_url(); ?>Keyboard" role="tab" aria-controls="pills-Keyboard" aria-selected="false">Keyboard</a>
                </li>
