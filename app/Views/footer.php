        ...
        <div class="row">
            ...
            <div class="col-md-4 col-6 footer-div pt-4">
                <ul>
                    ...
                    <li>
                        <a href="<?php echo base_url('Carrier'); ?>">Carrier</a>
                    </li>
                    <li>
        ...
        <div class="row">
            <div class="col-md-12 col-12 mt-3">
                <div class="social-div text-center">
                    <a href="https://www.instagram.com/enatyam.india/" class="insta-div"><i
                            class="fa fa-instagram"></i></a>
                    <a href="https://twitter.com/e_natyam?s=08" class="twitter-div"><i class="fa fa-twitter"
