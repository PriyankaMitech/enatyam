...
$(document).ready(function() {
    ...
    $("#signupbtn").click(function() {
        ...
        var valid = true
        $('#confirmpasswordError, #passwordError, #nameError, #emailError, #mobile_noError').addClass(
            'd-none')
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == '203') {
                        $('#otp').removeClass('d-none').after('<span id="otperror">' +
                            response.msg + '</span>')
                    } else {
                        if (response.mobileexist == true) {
                            $('#mobile_noError').addClass('d-none');
                            $('#mobile_noError').removeClass('d-none').text(
                            ...
                            if (response.status == '200') {
                                ...
                                $('#otp').removeClass('d-none').after(
                                    '<span id="otperror">Enter otp sent to your mobile no.</span>'
                                )
                            }
                        }
                    }
