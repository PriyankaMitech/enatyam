...
<div class="content-wrapper">
    ...
    <?php if (!empty($renewalYes)): ?>
        <table class="table table-hover text-nowrap">
            ...
            <tbody>
                <?php $uniqueStudentsRenewalYes = []; ?>
                <?php foreach ($renewalYes as $student): ?>
                    <?php if (!in_array($student->student_registerid, $uniqueStudentsRenewalYes)): ?>
                        <?php $uniqueStudentsRenewalYes[] = $student->student_registerid; ?>
                        <tr class="student-row">
                            <td><?= count($uniqueStudentsRenewalYes); ?></td>
