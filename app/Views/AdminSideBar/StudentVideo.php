                        ...
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">
                                        Faculty Videos</a></li>
                                <li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab"> Student
                                        Videos</a></li>
                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" class="form-control" id="startDate"
                                                                ...
                                                                value="<?php if (strpos($currentUrl, 'searchFacultyVideos') !== false && !empty(session()->getFlashdata('startDate'))) {
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" class="form-control" id="endDate"
                                                                ...
                                                                value="<?php if (strpos($currentUrl, 'searchFacultyVideos') !== false && !empty(session()->getFlashdata('endDate'))) {
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="dropdown" name="facultyName"
                                                                class="form-control custom-select">
                                                                <option value="">Select</option>
                                                                <?php foreach ($facultyList as $item) : ?>
                                                                <option value="<?= $item->id; ?>"
                                                                    <?php if (strpos($currentUrl, 'searchFacultyVideos') !== false && !empty(session()->getFlashdata('facultyName')) && session()->getFlashdata('facultyName') === $item->id) echo 'selected'; ?>>
                                                                    <?= $item->full_name; ?>
                                                                </option>
                                                                <?php endforeach; ?>
                                                            </select>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="dropdown" name="studentName"
                                                                class="form-control custom-select">
                                                                <option value="">Select</option>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group text-right">
                                                            <input type="hidden" name="table"
                                                                value="uplode_video_to_student">
                                                            <button type="button" value="searchfacvideo"
                                                                id="searchfacvideo"
                                                    ...
                                                    <div class="position-relative videoofs">
                                                        ...
                                                        <video width="100%" height="200px" controls
                                                            ...
                                                            <source class="img-fluid"
                                                                src="<?= base_url('public/uploads/FacultyUplodedVideos/' . $data->video_name) ?>"
                                                                type="video/mp4">
                                                        </video>
                                                        ...
                                                        <div class="ribbon-wrapper ribbon-lg">
                                                            ...
                                                            <div class="ribbon"
                                                                style="background-color: <?= $randomColor ?>; text-lg">
                                                                <p class="card-text"
                                                        ...
                                                        <div class="p">
                                                            <p class="card-text"
                                                                style="padding: 6%; color:#fff; background-color: <?= $randomColor ?>">
                                                                Date &nbsp; : &nbsp; <?= $date; ?>
                                                                <br>
                                        ...
                                        <div class="tab-pane" id="timeline">
                                            <form action="<?php echo base_url(); ?>searchStudentVideos" method="post"
                                                id="studentVideoForm">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="endDate">End Date:</label>
                                                            <input type="date" class="form-control"
                                                                id="studentVideoEndDate" placeholder="Enter end date:"
                                                                name="endDate"
                                                                value="<?php if (strpos($currentUrl, 'searchFacultyVideos') !== false && !empty(session()->getFlashdata('endDate'))) {
                                                                                                                                                                                        echo session()->getFlashdata('startDate');
                                                                                                                                                                                    } ?>">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="dropdown">Select Faculty:</label>
                                                            <select id="facultyNamesDropdown" name="facultyName"
                                                                class="form-control custom-select">
                                                                <option value="">Select</option>
                                                                <?php foreach ($facultyList as $item) : ?>
                                                                <option value="<?= $item->id; ?>"
                                                                    <?php if (strpos($currentUrl, 'searchStudentVideos') !== false && !empty(session()->getFlashdata('facultyName')) && session()->getFlashdata('facultyName') === $item->id) echo 'selected'; ?>>
                                                                    <?= $item->full_name; ?>
                                                                </option>
                                                                <?php endforeach; ?>
                                                            </select>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="dropdown">Select Student:</label>
                                                            <select id="studentNamesDropdown" name="studentName"
                                                                class="form-control custom-select">
                                                                <option value="">Select</option>
                                                                <?php foreach ($studentList as $item) : ?>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group text-right">
                                                            <input type="hidden" name="table"
                                                                value="uplode_study_video_from_student">
                                                ...
                                                <div class="col-sm-3 mt-3">
                                                    <div class="position-relative videoofs">
                                                        ...
                                                        <video width="100%" height="200px" controls
                                                            ...
                                                            <!-- Adjust the video size -->
                                                            <source class="img-fluid"
                                                                src="<?= base_url('public/uploads/videos/' . $data->name) ?>"
                                                                type="video/mp4">
                                                        </video>
