        ...
        <div class="col-lg-12 col-md-12 col-12 p-5 mt-5" style="background-color: black;">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-12 textPara-col kathakp">
                        <h2 class="heading text-white">Feel the Beat and Learn Tabla with Expert Guidance!</h2>
                        <p class="text-white">
                        Step into the world of traditional Indian music with the tabla, a versatile and expressive percussion instrument. Perfect for beginners and experienced drummers alike, the tabla offers a unique opportunity to explore complex rhythms and develop musical skills.                        </p>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 textPara-col kathakp">
                        <img src="<?php echo  base_url(); ?>public/images/instrument/Tabla.jpeg" class="rightimg" alt="Yoga Class" style="width:100%;">
                    </div>
                </div>
            </div>
        </div>
