                ...
                <div class="card button1-card"
                    ...
                    <div class="price-card-body">
                        ...
                        <ul style="padding-left:7px!important">
                            ...
                            <input class="btn btn-primary btn1" data-bs-toggle="modal" data-bs-target="#registerformpopup"
                                value="Book Now">
                            <?php else : ?>
                            <a class="btn btn-primary" href="<?php echo base_url('Checkout'); ?>?id=1"
                ...
                <div class="card button1-card"
                    ...
                    <div class="price-card-body">
                        ...
                        <ul style="padding-left:7px!important">
                            ...
                            <?php if (!(session()->get('sessiondata'))) : ?>
                            <input class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#registerformpopup"
                                value="Book Now">
                            <?php else : ?>
                            <a class="btn btn-primary" href="<?php echo base_url('Checkout'); ?>?id=2"
                                type="button">Book Now</a>
                    ...
                    <div class="price-card-body">
                        ...
                        <ul style="padding-left:7px!important">
                            ...
                            <input class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#registerformpopup"
                                value="Book Now">
                            <?php else : ?>
                            <a class="btn btn-primary" href="<?php echo base_url('Checkout'); ?>?id=3"
                                type="button">Book Now</a>
                    ...
                    <div class="price-card-body">
                        ...
                        <ul class="" style="padding-left:9px!important">
                            ...
                            <input class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#registerformpopup"
                                value="Book Now">
                            <?php else : ?>
                            <a class="btn btn-primary" href="<?php echo base_url('Checkout'); ?>?id=4"
                                type="button">Book Now</a>
                    ...
                    <div class="price-card-body">
                        ...
                        <ul class="" style="padding-left:7px!important">
                            ...
                            <input class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#registerformpopup"
                                value="Book Now">
                            <?php else : ?>
                            <a class="btn btn-primary" href="<?php echo base_url('Checkout'); ?>?id=5"
                                type="button">Book Now</a>
                    ...
                    <div class="price-card-body">
                        ...
                        <ul style="padding-left:7px!important">
                            ...
                            <input class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#registerformpopup"
                                value="Book Now">
                            <?php else : ?>
                            <a class="btn btn-primary" href="<?php echo base_url('Checkout'); ?>?id=6"
                                type="button">Book Now</a>
