                ...
                <div class="modal-body">
                    ...
                    <form action="saveuserdata" method="post">
                        ...
                        <div class="form-check">
                            <!-- <input class="form-check-input terms" type="checkbox" value="" id="flexCheckDefault">
                            <label class="form-check-label" for="flexCheckDefault">
                                I am agree to all terms and conditions
                            </label> -->
                            <!-- <label>
                                <input type="checkbox" id="termsCheckbox"> I agree to the<a href="#termsConditions"> terms and conditions</a>
                            </label> -->
                            <!-- Checkbox with label and link to open the modal -->
                            <label>
                        ...
                        <!-- <input type="submit" class="btn btn-light mt-3" id="clicktoTerms"> -->
                        <button type="button" class="btn btn-light mt-3" id="btncheck" disabled>Submit</button>
                ...
                <div class="modal-body">
                    <div class="login_form">
                        ...
                        <form name="loginForm" onsubmit="return validateFormLogin()" action="<?php echo base_url(); ?>login" id="loginform" method="post">
                            <div class="form-group m-2"><input type="text" name="username" id="username" class="form-control" aria-required="true" placeholder="Email or Mobile number"><span id="usernameError" style="color: red;"></span></div>
                            <div class="form-group  m-2"><input type="password" name="password" id="password" class="form-control" aria-required="true" placeholder="Password"><span id="passwordError1" style="color: red;"></span></div>
                            <div class="forgetmenot login-remember"><a class="lost-pass-link" href="javascript:void(0);" title="Lost Password" onclick="showLostPasswordModal()">Lost your password?</a></div>
                    </div><input type="submit" value="Login" class="btn btn-light mt-3">
                    <p>Not a member yet? <a class="Register" href="javascript:void(0);" onclick="showRegistrationModal()" data-bs-toggle="modal" data-bs-target="#registerformpopup">Register</a></p>
                    </form>
                </div>
            </div>
        </div>
                ...
                <div class="modal-body">
                    <div class="login_form">
                        ...
                        <form name="lostPasswordForm" action="<?php echo base_url(); ?>lostpassword" id="lostpasswordform" method="post">
                            <div class="form-group"><input type="email" name="lostpassword_email" id="lostpassword_email" class="form-control" aria-required="true" placeholder="Email"><span id="lostpassword_email_error" style="color: red;"></span></div><button type="submit" class="btn btn-light mt-3">Recover Password</button>
                        </form>
                        ...
                        <form name="otpValidateForm" action="<?php echo base_url(); ?>otpvalidate" id="otpValidateForm" method="post">
                            <div id="otpField" style="display: none;">
                                <div class="form-group"><input type="text" name="entered_otp" id="entered_otp" class="form-control" placeholder="Enter OTP"><span id="invalidotp" style="color: red;"></span></div><button type="submit" class="btn btn-light mt-3">Submit OTP</button>
                            </div>
                        </form>
                        <form name="newPasswordForm" action="<?php echo base_url(); ?>newpassword" id="newPasswordForm" method="post">
                            <div id="passwordField" style="display: none;">
                                <div class="form-group"><input type="password" name="new_password" id="new_password" class="form-control" aria-required="true" placeholder="Enter New Password"><input type="password" name="conf_password" id="conf_password" class="form-control" aria-required="true" placeholder="Confirm Password"><span id="password_match_error" style="color: red;"></span></div><button type="submit" class="btn btn-light mt-3">Submit New Password</button>
                            </div>
                        </form>
