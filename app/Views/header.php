...
<head>
    ...
    <?php } else if ($page == 'Dance') { ?>
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>public/css/Instruments.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>public/css/dancepage.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>public/css/Instrumentsfaq.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>public/css/Instrumentpage.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>public/css/commingsoon.css">
    ...
    <?php } else if ($page == 'music') { ?>
        ...
        <link rel="stylesheet" href="<?php echo base_url() ?>public/css/dancepage.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>public/css/Instrumentsfaq.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>public/css/DanceInstructer.css">
    ...
    <?php } else if ($page == 'Yoga') { ?>
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>public/css/Yogapage.css">
    ...
    <?php } else if ($page == 'Carrier') { ?>
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>public/css/Carrier.css">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="register_form">
                        ...
                        <form name="registrationForm" onsubmit="return validateForm()" method="post" action="<?php echo base_url(); ?>register">
