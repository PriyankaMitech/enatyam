 ...
 */
    ...
    :root {
     ...
     Sets aspect ratio width and height in scrolling playlist grid */
        ...
        /* MAX WIDTH of PLAYER */
        --parent-container-max-width: 980px;
        /* <-- PLAY WITH ME */
    }
        ...
        <div class="typesOfDance-tab">
                ...
                <div class="">
                    <div class="row text-lg-start">
                            ...
                            <div class="ThumbnailImg " style="text-align: center;">
                                <a href="<?= base_url(); ?>online-kathak-classes" target="" class="d-block h-100">
                                    <img class="img-fluid img-thumbnail"
                                        src="<?php echo  base_url(); ?>public/images/courseoffering/1-rbg.webp" alt="online kathak classes">
                                </a>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            ...
                            <div class="ThumbnailImg " style="text-align: center;">
                                <a href="<?= base_url(); ?>online-bharatanatyam-classes" target="" class="d-block h-100">
                                    <img class="img-fluid img-thumbnail"
                                        src="<?php echo base_url(); ?>public/images/courseoffering/2-rbg.webp" alt="online bharatanatyam classes">
                                </a>
                            </div>
                            <div class="float-left cimgb cimgbr">
                                <ul class="list-inline thumbnailList">
                                    ...
                                    <li class="list-inline-item thumbnailListItem"> <?php
                                        ...
                                        ?> <i class="fa fa-star" style="color:#fad32c"></i>
                                    </li>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 col-6">
                            ...
                            <div class="ThumbnailImg " style="text-align: center;">
                                <a href="<?= base_url(); ?>online-bollywood-dance-classes" target="" class="d-block h-100">
                                    <img class="img-fluid img-thumbnail"
                                        src="<?php echo base_url(); ?>public/images/courseoffering/3-rbg.webp" alt="online bollywood dance classes">
                                </a>
                            </div>
                            <div class="float-left cimgb cimgbr">
                                <ul class="list-inline thumbnailList">
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            ...
                            <div class="ThumbnailImg " style="text-align: center;">
                                <a href="<?= base_url(); ?>online-western-dance-classes" target="" class="d-block h-100">
                                    <img class="img-fluid img-thumbnail"
                                        src="<?php echo base_url(); ?>public/images/courseoffering/4-rbg.webp" alt="online western dance classes">
                                </a>
                            </div>
                            <div class="float-left cimgb cimgbr">
                                <ul class="list-inline thumbnailList">
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            ...
                            <div class="ThumbnailImg " style="text-align: center;">
                                <a href="<?= base_url(); ?>online-hindustani-music-classes" target="" class="d-block h-100">
                                    <img class="img-fluid img-thumbnail"
                                        src="<?php echo base_url(); ?>public/images/courseoffering/5-rbg.webp" alt="online hindustani classical music classes">
                                </a>
                            </div>
                            <div class="float-left cimgb cimgbr">
                                <ul class="list-inline thumbnailList">
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            ...
                            <div class="ThumbnailImg " style="text-align: center;">
                                <a href="<?= base_url(); ?>online-carnatic-music-lessons" target="" class="d-block h-100">
                                    <img class="img-fluid img-thumbnail"
                                        src="<?php echo base_url(); ?>public/images/courseoffering/6-rbg.webp" alt="online carnatic singing classes">
                                </a>
                            </div>
                            <div class="float-left cimgb cimgbr">
                                <ul class="list-inline thumbnailList">
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            ...
                            <div class="ThumbnailImg " style="text-align: center;">
                                <a href="<?= base_url(); ?>online-western-singing-classes" target="" class="d-block h-100">
                                    <img class="img-fluid img-thumbnail"
                                        src="<?php echo base_url(); ?>public/images/courseoffering/7-rbg.webp" alt="western vocal classes online">
                                </a>
                            </div>
                            <div class="float-left cimgb cimgbr">
                                <ul class="list-inline thumbnailList">
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            ...
                            <div class="ThumbnailImg " style="text-align: center;">
                                <a href="<?= base_url(); ?>online-playback-singing-classes" target="" class="d-block h-100">
                                    <img class="img-fluid img-thumbnail"
                                        src="<?php echo base_url(); ?>public/images/courseoffering/8-rbg.webp" alt="online playback singing class">
                                </a>
                            </div>
                            <div class="float-left cimgb cimgbr">
                                <ul class="list-inline thumbnailList">
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            ...
                            <div class="ThumbnailImg " style="text-align: center;">
                                <a href="<?= base_url(); ?>Yoga" target="" class="d-block h-100">
                                    <img class="img-fluid img-thumbnail"
                                        src="<?php echo base_url(); ?>public/images/courseoffering/9-rbg.webp" alt="yoga sessions online">
                                </a>
                            </div>
                            <div class="float-left cimgb cimgbr">
                                <ul class="list-inline thumbnailList">
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            ...
                            <div class="ThumbnailImg " style="text-align: center;">
                                <a href="<?= base_url(); ?>online-meditation-classes" target="" class="d-block h-100">
                                    <img class="img-fluid img-thumbnail"
                                        src="<?php echo base_url(); ?>public/images/courseoffering/10-rbg.webp" alt="online meditation class">
                                </a>
                            </div>
                            <div class="float-left cimgb cimgbr">
                                <ul class="list-inline thumbnailList">
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            ...
                            <div class="ThumbnailImg " style="text-align: center;">
                                <a href="<?= base_url(); ?>online-nutrition-counselling-classes" target="" class="d-block h-100">
                                    <img class="img-fluid img-thumbnail"
                                        src="<?php echo base_url(); ?>public/images/courseoffering/11-rbg.webp" alt="nutritionist online consultation">
                                </a>
                            </div>
                            <div class="float-left cimgb cimgbr">
                                <ul class="list-inline thumbnailList">
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            ...
                            <div class="ThumbnailImg " style="text-align: center;">
                                <a href="<?= base_url(); ?>Instruments" target="" class="d-block h-100">
                                    <img class="img-fluid img-thumbnail"
                                        src="<?php echo base_url(); ?>public/images/courseoffering/12-rbg.webp" alt="online playable piano">
                                </a>
                            </div>
                            <div class="float-left cimgb cimgbr">
                                <ul class="list-inline thumbnailList">
            ...
            <div class="row p-3 MusicSec1">
                <div class="col-md-6 col-12">
                    <img src="<?= base_url(); ?>public/images/Home/4.webp" class="danceimg1 home" alt="online dance classes">
            ...
            <div class="MusicSec MusicSec1">
                <div class="row m-0 omcd">
                    ...
                    <div class="col-md-6 col-12 p-0 text-center">
                        <img src="<?= base_url(); ?>public/images/Home/11.webp" class="danceimg home" alt="online singing classes">
                    </div>
                </div>
            </div>
            ...
            <div class="p-3 MusicSec1">
                <div class="row m-0">
                    <div class="col-md-6 col-12 p-0">
                        <img src="<?= base_url(); ?>public/images/Home/14.webp" class="danceimg1 home" alt="yoga sessions online">
                    </div>
            ...
            <div class="MusicSec MusicSec1">
                <div class="row m-0 omcd">
                    ...
                    <div class="col-md-6 col-12 p-0 text-center omici">
                        <img src="<?= base_url(); ?>public/images/instrument/OnlineMusicHome.png" class="danceimg home" alt="online playable piano">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="owl-carousel owl-theme">
                    <div class="item" onclick="showModal('Aditya', 'Yoga Faculty', 'public/images/facultyProfileLatest/2.webp','M.Sc.(Human Consciousness and Yogic Science)','Certification YTTC: 200 Hours & E-RYT 500','4 years +','Hath Yoga, Yoga for Strength and Fitness - Weight Management - Yoga for Anxiety and Stress Management, Mindfulness Practices - Weight Loss, Flexibility and Fitness, Chronic Illness')">
                        <div class="faculty-div">
                            <div class="faculty-div1">
                                <img src="<?= base_url(); ?>public/images/facultyProfileLatest/2.webp" alt="online yoga classes" />
                            </div>
                    ...
                    <div class="item" onclick="showModal('Priti S', 'Kathak Dance Faculty', 'public/images/priti.jpg','M.A. in Performing Arts(Kathak)', 'Gold Medalist in Kathak (University Topper)','15 Years +','Kathak, Semi classical and Choreography, An internationally acclaimed kathak artist and professionally trained and graced many international stage')">
                        <div class="faculty-div">
                            <div class="faculty-div1">
                                <img src="<?= base_url(); ?>public/images/priti.jpg" alt="kathak dance classes online" />
                            </div>
                            <div class="faculty-content mt-lg-4">
                    ...
                    <div class="item" onclick="showModal('Priyanka B', 'Kathak Dance Faculty', 'public/images/priyanka.jpeg','M.A. in Performing Arts(Kathak)','','5 Years +','Kathak, Semi classical and Choreography, Worked with many Bollywood choreographer and performed at many national level renowed stages')">
                        <div class="faculty-div">
                            <div class="faculty-div1">
                                <img src="<?= base_url(); ?>public/images/priyanka.jpeg" alt="learn kathak online" />
                            </div>
                            <div class="faculty-content mt-lg-4">
                    ...
                    <div class="item" onclick="showModal('Supriya', 'Yoga Faculty', 'public/images/facultyProfileLatest/4.webp','Post Gratuate Diploma in Yoga Science','YTTC 100hrs','Experience 3 Years +','Prenatal Yoga - Yoga for Chronic Disease - Weight Management - Yoga for Kids - Meditation and Mindfulness Vinayasa Flow, Pranayama, Yoga Nidra, Yoga Therapy, Back, Neck and Knee Pains')">
                        <div class="faculty-div">
                            <div class="faculty-div1">
                                <img src="<?= base_url(); ?>public/images/facultyProfileLatest/4.webp" alt="online classes yoga" />
                            </div>
                            <div class="faculty-content mt-lg-4">
                    ...
                    <div class="item" onclick="showModal('Amrita M', 'Yoga Faculty', 'public/images/facultyProfileLatest/6.webp', 'M.Sc.(Human Consciousness and Yogic Science)', 'YTTC 125 Hrs', '3+ years','Prenatal Yoga - Yoga for Chronic Disease - Weight Management - Yoga for Kids - Meditation and Mindfulness Vinayasa Flow, Pranayama, Yoga Nidra, Yoga Therapy, Back, Neck and Knee Pains')">
                        <div class="faculty-div">
                            <div class="faculty-div1">
                                <img src="<?= base_url(); ?>public/images/facultyProfileLatest/6.webp" alt="yoga sessions online" />
                            </div>
                            <div class="faculty-content mt-lg-4">
                    ...
                    <div class="item" onclick="showModal('Shekhar Pathak', 'Yoga Faculty', 'public/images/facultyProfileLatest/8.webp','Ph.D. - Yogic Science, M.Sc.(Human Consciousness and Yogic Science)','Certification: YTTC 125 Hrs','10 years +','Yogic Management of Diseases - Accupressure Therpis - Pranic Healer - Hatha Yoga - Yoga for Anxiety and Stress Management, Mindfulness Practices - Weight Loss, Flexibility and Fitness')">
                        <div class="faculty-div">
                            <div class="faculty-div1">
                                <img src="<?= base_url(); ?>public/images/facultyProfileLatest/8.webp" alt="online yoga classes" />
                            </div>
                            <div class="faculty-content mt-lg-4">
                    ...
                    <div class="item" onclick="showModal('Vivek R', 'Yoga Faculty', 'public/images/facultyProfileLatest/10.webp','Ph.D. - Yogic and Sports Science, M.Sc.(Human Consciousness and Yogic Science), Diploma in Counselling Psychotherapy, B.Sc. in Military Science','YTTC 125 Hrs','4 years +','Hath Yoga, Yoga Nidra, Yoga for Strength and General Fitness, Weight Management, Yoga for Anxiety and Stress Management, Mindfulness Practices, Weight Loss, Flexibility and Fitness, Chronic Illness')">
                        <div class="faculty-div">
                            <div class="faculty-div1">
                                <img src="<?= base_url(); ?>public/images/facultyProfileLatest/10.webp" alt="online yoga classes" />
                            </div>
                            <div class="faculty-content mt-lg-4">
                    ...
                    <div class="item" onclick="showModal('Swetha', 'Carnatic Music', 'public/images/sweta.jpg','MA in Carnatic Vocal','Trained over 500 students in Carnatic classical music','Teaching Experience 10 Years +','Carnatic Vocal and Sanskrit Chanting')">
                        <div class="faculty-div">
                            <div class="faculty-div1">
                                <img src="<?= base_url(); ?>public/images/sweta.jpg" alt="online carnatic singing classes" />
                            </div>
                            <div class="faculty-content mt-lg-4">
                    ...
                    <div class="item" onclick="showModal('Ketki M', 'Hindustani Music Faculty', 'public/images/ketki.jpg','MA in Hindustani Vocal','Doordarshan Grade Artist','6 Years +','Hindustani Vocal, Bollywood Singing, Plyback Singing, Expert in Vocal Cords, Ragas and Sur')">
                        <div class="faculty-div">
                            <div class="faculty-div1">
                                <img src="<?= base_url(); ?>public/images/ketki.jpg" alt="online hindustani classical music classes" />
                            </div>
                            <div class="faculty-content mt-lg-4">
                    ...
                    <div class="item" onclick="showModal('Koyali S', 'Hindustani Music Faculty', 'public/images/Koyali.png','MA in Hindustani Vocal','Doordarshan Grade Artist, Trained 500+ students, Nurturing musical excellence', '10 Years +','Hindustani Vocal, Bollywood Singing, Plyback Singing, Expert in Vocal Cords, Ragas and Sur')">
                        <div class="faculty-div">
                            <div class="faculty-div1">
                                <img src="<?= base_url(); ?>public/images/Koyali.png" alt="online hindustani classical music classes" />
                            </div>
                            <div class="faculty-content mt-lg-4">
                    ...
                    <div class="item" onclick="showModal('Krutika B', 'Bollywood Dance Faculty' ,'public/images/krutika.jpg','Bollywood Dance','Certified Bollywood Dance Faculty with training from Shaimak Davar Institute','4 Years +','Collaborated with renowned choreographers, Blending expertise in Choreography and performance for a dynamic teaching approach')">
                        <div class="faculty-div">
                            <div class="faculty-div1">
                                <img src="<?= base_url(); ?>public/images/krutika.jpg" alt="online bollywood dance classes" />
                            </div>
                            <div class="faculty-content mt-lg-4">
                ...
                <div class="row">
                    <div class="col-6">
                        <button class="lazyload active" data-iframe="https://www.youtube.com/embed/LxDF2EzI-8Y?si=3Wn_7WSJj0wgu-B" data-caption="Jon Batiste ♩ FREEDOM">
                            <img src="https://img.youtube.com/vi/LxDF2EzI-8Y/maxresdefault.jpg" alt="Student giving feedback on an online Kathak dance class, highlighting the benefits and experience of learning Kathak through virtual lessons." width="100%">
                        </button>
                    </div>
                    <div class="col-6">
                        <button class="lazyload" data-iframe="https://www.youtube.com/embed/NzijGFASF-g?si=X06ri0G3t8iOEpM8" data-caption="Jon Batiste ♩ FREEDOM">
                            <img src="https://img.youtube.com/vi/NzijGFASF-g/maxresdefault.jpg" alt="Transformation from beginner to 12 months later in online Kathak dance class. Watch the journey of mastering Kathak through dedicated online lessons." width="100%">
                        </button>
                    </div>
                    <div class="col-6">
                        <button class="lazyload" data-iframe="https://www.youtube.com/embed/b69s332yQnc?si=9I8c5ZlkC5zbeS9F" data-caption="Jon Batiste ♩ FREEDOM">
                            <img src="https://img.youtube.com/vi/b69s332yQnc/maxresdefault.jpg" alt="Parent giving feedback on an online Kathak dance class, highlighting the benefits and experience of learning Kathak through virtual lessons." width="100%">
                        </button>
                    </div>
                    <div class="col-6">
                        <button class="lazyload" data-iframe="https://www.youtube.com/embed/eKR1C0KdLYQ?si=T3vlx1me-63_gNmg" data-caption="Luke James ♩ SHINE ON">
                            <img src="https://img.youtube.com/vi/eKR1C0KdLYQ/maxresdefault.jpg" alt="Bollywood dance teacher showcasing a captivating performance on Dance India Dance stage, highlighting intricate footwork, expressive gestures, and classical grace." width="100%">
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="owl-carousel owl-theme">
                    <div class="item">
                        <div class="item in">
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 mb-5">
                                    <img src="<?= base_url(); ?>public/images/happyfaces/1h.webp" alt="Aiden C ( London-UK )" class="centered-image" />
                                    <div class="hft">
                        ...
                        <div class="item in">
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 mb-5">
                                    <img src="<?= base_url(); ?>public/images/happyfaces/2h.webp" alt="Sweta ( Australia )" class="centered-image" />
                                    <div class="hft">
                    ...
                    <div class="item">
                        <div class="item in">
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 mb-5">
                                    <img src="<?= base_url(); ?>public/images/happyfaces/3h.webp" alt="Sneha ( Canada )" class="centered-image" />
                                    <div class="hft">
                                        <h5>Sneha ( Canada )</h5>
                        ...
                        <div class="item in">
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 ">
                                    <img src="<?= base_url(); ?>public/images/happyfaces/4h.webp" alt="Kavita ( Pune )" class="centered-image" />
                                    <div class="hft">
                                        <h5>Kavita ( Pune )</h5>
                    ...
                    <div class="item">
                        <div class="item in">
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 ">
                                    <img src="<?= base_url(); ?>public/images/happyfaces/7h.webp" alt="Rajiv ( Lucknow )" class="centered-image" />
                                    <div class="hft">
                                        <h5>Rajiv ( Lucknow )</h5>
                        ...
                        <div class="item in">
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 mb-5">
                                    <img src="<?= base_url(); ?>public/images/happyfaces/6h.webp" alt="Ayesha ( Singapore )" class="centered-image" />
                                    <div class="hft">
                    ...
                    <div class="item">
                        <div class="item in">
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 mb-5">
                                    <img src="<?= base_url(); ?>public/images/happyfaces/8h.webp" alt="Vikram ( Delhi )" class="centered-image" />
                                    <div class="hft">
                                        <h5>Vikram ( Delhi )</h5>
                        ...
                        <div class="item in">
                            ...
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 ">
                                    <img src="<?= base_url(); ?>public/images/happyfaces/10h.webp" alt="Vishal ( Chandigarh )" class="centered-image" />
                                    <div class="hft">
                    ...
                    <div class="item">
                        <div class="item in">
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 mb-5">
                                    <img src="<?= base_url(); ?>public/images/happyfaces/11h.webp" alt="Kajal ( Delhi )" class="centered-image" />
                                    <div class="hft">
                                        <h5>Kajal ( Delhi )</h5>
                        ...
                        <div class="item in">
                            ...
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 ">
                                    <img src="<?= base_url(); ?>public/images/happyfaces/12h.webp" alt="Scarlett family ( Germany )" class="centered-image" />
                                    <div class="hft">
                    ...
                    <div class="item">
                        <div class="item in">
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 mb-5">
                                    <img src="<?= base_url(); ?>public/images/happyfaces/14h.webp" alt="Emma ( UK )" class="centered-image" />
                                    <div class="hft">
                                        <h5>Emma ( UK )</h5>
                        ...
                        <div class="item in">
                            ...
                            <div class="happyFaces-div">
                                <div class="happyFaces-div1 ">
                                    <img src="<?= base_url(); ?>public/images/happyfaces/15h.webp" alt="Michael (Mike) ( USA )" class="centered-image" />
                                    <div class="hft">
    ...
    <div class="container cont-width">
        <div class="row">
            <div class="col-lg-12 text-center coming-soon-img ">
                <img src="<?= base_url(); ?>public/images/logo3.png" width="15%" alt="comming soon"
                ...
                <div class="row coms-row">
                    ...
                    <div class="col-lg-6 col-md-5  ">
                        <p class="comming-soon-p">Exciting times ahead! We are thrilled to announce that a new
                            ...
                            launch an enriching learning experience for<br> children everywhere!
                        </p>
...
<section class="tstmwy">
    <div class="container ">
        <div class="row">
            ...
            <img src="<?php echo base_url(); ?>public/images/Home/GoesWhereverGo!.webp" alt="The Studio That Moves With You" />
        </div>
    </div>
</section>
    ...
    <div class="modal-content wm">
        ...
        <div class="staff-wrapper maxwidth">
            <article class="staff-box">
                <img src="" alt="Susan Stark" id="imgf" alt="Experienced faculty members" />
...
<div id="reviewModal" class="modal">
    <div class="modal-content wm">
        ...
        <div class="staff-wrapper maxwidth">
            <article class="staff-box">
                <img src="" alt="Susan Stark" id="imgh" alt="comprehensive online course review" />
