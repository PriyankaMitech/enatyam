        ...
        <div class="col-lg-12 col-md-12 col-12 p-5 mt-5" style="background-color: black;">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-12 textPara-col kathakp">
                        <h2 class="heading text-white">Unleash the Elegance of the Violin</h2>
                        <p class="text-white">
                        Step into the world of timeless music with the violin, an instrument celebrated for its versatility and expressive power. Whether you're just starting or an experienced musician, the violin offers an enriching musical journey.                        </p>
                    ...
                    <div class="col-lg-6 col-md-6 col-12  textPara-col kathakp" >
                        <img src="<?php echo  base_url(); ?>public/images/instrument/Violin.jpeg" class="rightimg" alt="Yoga Class" style="width:100%;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container dancepagec">
        <div class="typesOfYoga-tab">
            <!-- <ul class="row nav nav-pills mb-3" id="pills-tab" role="tablist">
                ...
                <li class="col-lg-2 col-md-2 col-6 nav-item" role="presentation">
                    <a class="nav-link active" id="pills-Violin-tab" href="<?=base_url(); ?>Violin" data-url="<?=base_url(); ?>Violin" role="tab" aria-controls="pills-Violin" aria-selected="false">Violin</a>
                </li>
