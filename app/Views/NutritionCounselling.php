        ...
        <div class="col-lg-12 col-md-12 col-12 p-5" style="background-color: black;">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-12 textPara-col kathakp">
                        <h2 class="heading text-white">Elevate Your Health with Our Nutrition Counseling Course</h2>
                        <p class="text-white">
                        Unlock the secrets to a healthier lifestyle with our comprehensive Nutrition Counseling course. Designed to educate and empower, this course offers personalized nutrition plans, expert guidance, and practical strategies to help you achieve your wellness goals.                        </p>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 textPara-col kathakp">
                        <img src="<?=base_url(); ?>public/images/Yoga/NutritionCounselling.jpeg" alt="NutritionCounselling" class="rightimg" alt="Yoga Class" style="width:100%;">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="tab-pane fade show active" id="pills-PrenatalYoga" role="tabpanel" aria-labelledby="pills-PrenatalYoga-tab">
                    ...
                    <img src="<?=base_url(); ?>public/images/boarder1.webp" alt="Image Description" class="img-fluid">
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <img src="<?=base_url(); ?>public/images/Yoga/NutritionCounsellingImg.svg" alt="NutritionCounsellingImg" class="danceimg">
                        </div>
                        ...
                        <div class="container">
                            <div class="row ">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    ...
                                    <img src="<?=base_url(); ?>public/images/Yoga/YogaImg2.svg" alt="YogaImg" class="danceimg">
                            ...
                            <div class="month-row">
                                ...
                                <div class="col-lg-12 col-12 text-center testimonialsdiv">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg" alt="YogaImg1" class="danceimgy">
                        ...
                        <div class="container">
                            ...
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg" alt="YogaImg2" class="danceimgy">
                        ...
                        <div class="container">
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg"  alt="YogaImg4" class="danceimgy">
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-12">
                                        <!-- trying new tab  -->
                                        <ul class="row nav nav-pills mb-3" id="pills-tab" role="tablist">
                        ...
                        <div class="container">
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg"  alt="YogaImg6" class="danceimgy">
                        ...
                        <div class="container">
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg"  alt="YogaImg7" class="danceimgy">
                        ...
                        <div class="container">
                            <div class="month-row">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12 text-center muduleimg">
                                        <img src="<?=base_url(); ?>public/images/Yoga/YogaImg3.svg"  alt="YogaImg77" class="danceimgy">
                        ...
                        <div class="col-lg-3 col-md-3 col-6">
                            ...
                            <div class="ThumbnailImg " style="text-align: center;">
                                <a href="<?= base_url(); ?>online-semiclassical-music-lessons" target="" class="d-block h-100">
                                    <img class="img-fluid img-thumbnail" src="<?php echo base_url(); ?>public/images/courseoffering/opc2.png" alt="courseoffering2">
                                </a>
                            </div>
                            <div class="text-center mt-2">
                        ...
                        <div class="col-lg-3 col-md-3 col-6">
                            ...
                            <div class="ThumbnailImg " style="text-align: center;">
                               <a href="<?= base_url(); ?>online-bhangra-lessons" target="" class="d-block h-100">
                                    <img class="img-fluid img-thumbnail" src="<?php echo base_url(); ?>public/images/courseoffering/opc3.png" alt="courseoffering3">
                                </a>
                            </div>
                            <div class="text-center mt-2">
                        ...
                        <div class="col-lg-3 col-md-3 col-6">
                            ...
                            <div class="ThumbnailImg " style="text-align: center;">
                                <a href="<?= base_url(); ?>online-folk-dance-classes" target="" class="d-block h-100">
                                    <img class="img-fluid img-thumbnail" src="<?php echo base_url(); ?>public/images/courseoffering/opc4.png" alt="courseoffering4">
                                </a>
                            </div>
                            <div class="text-center mt-2">
